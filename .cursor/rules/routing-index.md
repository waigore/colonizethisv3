...
| `colonizethis-game-manual.mdc` | Player game manual (`docs/manual/`) maintenance and SPEC-change review |
...
| Player game manual (`docs/manual/**`) or player-facing SPEC edits (`SPEC/game/**`, `SPEC/ui/**`, allowlisted `SPEC/program/` order/turn files) | always-applied only | always-applied + `game-manual` | Require manual chapter review (or justify non-update) and style-guide compliance |
