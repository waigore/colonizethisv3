...
void main() {
  ...
  group('ProvinceSeaZoneDetailOverlay dark editorial-monocle Tile section '
      ...
      'live-data body rows)', () {
    testWidgets('coordinates row resolves to EditorialMonoclePalette.fg under '
    ...
    testWidgets('terrain row resolves to EditorialMonoclePalette.fg under '
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final text = _findTileBodyText(tester, 'Civilian units (province): ');
        expect(
          text.style?.color,
          EditorialMonoclePalette.fg,
          reason:
