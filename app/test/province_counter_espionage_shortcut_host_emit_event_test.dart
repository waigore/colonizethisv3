// Pins host-level MAP20001 Counter-espionage tap → OpenCivilianUnitsPanelEvent.
// SPEC: SPEC/ui/province-sea-zone-detail-overlay.md (Refs #4528).
...
const String _kProvinceLevelKey = 'oldWorld|p1|0|0';
...
void main() {
  ...
  for (final host in provinceShortcutHostCases) {
    testWidgets(
      '${host.label} Counter-espionage emits spyOnly Assign shortcut',
      (tester) async {
