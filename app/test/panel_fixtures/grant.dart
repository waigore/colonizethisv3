...
///
/// `GrantOrSubsidyListener` reads `game.worldState.turnState.turnNumber` and
/// `game.globalGameSeed` for the negotiation-mood event seed (Refs #4415) —
/// never any generated map/topology data. The fixture provides one human
/// ([kPanelTestHumanPlayerId]) and one AI great power so the suite can resolve
/// a human payer and a non-human grant/subsidy target.
