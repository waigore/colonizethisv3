...
void main() {
  ...
  group('ProductionCommodityBreakdownDialog '
    ...
    testWidgets('renders the commodity-breakdown title and a Close button', (
      WidgetTester tester,
    ) async {
      await pumpDialog(tester);
    ...
    testWidgets('tapping Close dismisses the dialog and emits no bus events', (
      WidgetTester tester,
    ) async {
      var eventCount = 0;
      ...
      expect(find.byType(ProductionCommodityBreakdownDialog), findsNothing);
      expect(eventCount, 0);
    });
  });
}
