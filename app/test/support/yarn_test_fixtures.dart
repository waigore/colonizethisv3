...
// dialogue overlay pins (Refs #3952).
//
// Dialogue / intervention / tribe-first-contact tests previously each declared
// private `_StringAssetBundle` / `_InlineYarnAssetBundle` /
// `_FailingAssetBundle` fakes. Canonical fakes and reusable short Yarn live
// here; overlay tests keep only scenario-specific yarn and assertions.
