...
void main() {
  ...
  group('ProvinceSeaZoneDetailOverlay dark editorial-monocle Tile section '
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildProvinceOverlayWithRoadLevelFullPlayerView(roadLevel: 2),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildProvinceOverlayWithRoadLevelFullPlayerView(roadLevel: 1),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildProvinceOverlayWithRoadLevelFullPlayerView(roadLevel: 4),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          buildProvinceOverlayWithRoadLevelFullPlayerView(roadLevel: 0),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets('disabled Explore inline icon resolves to '
    ...
    testWidgets('disabled Prospect inline icon resolves to '
        'EditorialMonoclePalette.muted at alpha 0.65', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
    ...
    testWidgets('disabled Build improvement inline icon resolves to '
        'EditorialMonoclePalette.muted at alpha 0.65', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
