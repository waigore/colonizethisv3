...
import 'dialogue_overlays_specs_view_and_intro_support.dart';
...
void main() {
  ...
  group('GameStartIntroOverlay (SPEC/ui/game-start-intro-overlay.md)', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await expectGameStartIntroScrimUsesDialogToken(
          tester,
          lineBundle: YarnInlineAssetBundle(kYarnGameStartIntroShort),
          errorBundle: YarnMissingNodeAssetBundle(),
        );
      },
    );
    ...
    test('widget source does not reference Colors.black54 as the scrim '
      ...
      expectGameStartIntroSourceContract();
    });
  });
}
