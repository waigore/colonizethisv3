...
void main() {
  ...
  group('province overlay Political helpers (Refs #2865)', () {
    test('provinceOverlayRegionLabel maps oldWorld/newWorld and falls back', () {
      ...
      expect(provinceOverlayRegionLabel(l10n, 'mysteryRegion'), 'mysteryRegion');
    });
    ...
    test('provinceOverlayIsCapital is true for a faction capital, false '
      ...
      final owned = _ownedProvinceId(game: base, ownerId: humanId);
  ...
  group(
    'ProvinceSeaZoneDetailOverlay Political Region + Capital rows '
    ...
    () {
      testWidgets('Region row renders the localized region label in fg', (
        ...
        expect(
          row.style?.color,
          EditorialMonoclePalette.fg,
          reason: 'Region row must resolve TextStyle.color to '
      ...
      testWidgets('Capital row reads "Capital: Yes" for a faction capital '
        ...
        expect(
          row.style?.color,
          EditorialMonoclePalette.fg,
          reason: 'Capital row must resolve TextStyle.color to '
              'EditorialMonoclePalette.fg.',
        );
      });
      ...
      testWidgets('Capital row reads "Capital: No" for a non-capital province', (
        ...
        await tester.pumpWidget(
          _darkOverlay(game: game, displayId: nonCapital),
        );
        await tester.pumpAndSettle();
