// Host gating and emit pins for MAP20001 capital Naval Train (Refs #4776).

import 'package:colonizethis_app/core/services/app_event_handler/app_event_handler_scope.dart'
    show trainNavalDialogId;
import 'package:colonizethis_app/features/game/flame/overlays/province_detail_overlay_host_support_train_naval.dart';
...
void main() {
  ...
  ProvinceTrainNavalOverlayControls controls({
    ...
    return buildProvinceTrainNavalOverlayControls(
      game: game,
  ...
  test('hides Train when Naval intel is obfuscated', () {
  ...
  test('tap emits OpenDialogEvent without panel close or hire', () async {
    ...
    final panels = <OpenNavalUnitsPanelEvent>[];
    final closes = <ClosePanelEvent>[];
    bus.on<OpenDialogEvent>().listen(opened.add);
    bus.on<OpenNavalUnitsPanelEvent>().listen(panels.add);
    ...
    expect(opened.single.dialogId, trainNavalDialogId);
