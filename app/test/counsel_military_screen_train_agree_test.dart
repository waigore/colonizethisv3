// Counsel screen Military tab train-Agree integration (Refs #4307).
...
void main() {
  ...
  setUpAll(() async {
    Hive.init('./.dart_tool/test_hive_counsel_military_screen_train');
    ...
    (WidgetTester tester) async {
      ...
      final builds =
          container
              ...
              .buildUnitOrdersByPlayerId[human] ??
          const [];
