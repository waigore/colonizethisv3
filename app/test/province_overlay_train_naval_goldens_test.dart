// Visual goldens for MAP20001 Naval Train variants (Refs #4776).
...
class _TrainNavalGoldenCase {
  const _TrainNavalGoldenCase({
    required this.name,
...
const _cases = [
  _TrainNavalGoldenCase(
    name: 'Naval Train enabled',
    goldenFile: 'goldens/province_overlay_train_naval_enabled.png',
    show: true,
    size: Size(640, 720),
  ),
  _TrainNavalGoldenCase(
    name: 'Naval Train hidden',
    goldenFile: 'goldens/province_overlay_train_naval_hidden.png',
    show: false,
    size: Size(640, 720),
  ),
  _TrainNavalGoldenCase(
    name: 'Naval Train 320 dp wrap',
    goldenFile: 'goldens/province_overlay_train_naval_320dp.png',
    show: true,
    size: Size(640, 720),
    overlayWidth: 320,
  ),
...
void main() {
  ...
  for (final c in _cases) {
    testWidgets('golden: ${c.name} (Refs #4776)', (tester) async {
