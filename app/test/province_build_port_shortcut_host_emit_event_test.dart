...
// `GameMapNarrowDetailOverlaySlot` narrow). Refs #4332.
...
class _GameServiceBuildPort extends GameService {
  _GameServiceBuildPort(super.box, super.adapter);
...
void main() {
    ...
    await pumpAppShell(
      ...
      overrides: [
        ...
        gameServiceProvider.overrideWith(
          (ref) => _GameServiceBuildPort(gamesBox, GameSaveAdapter()),
        ),
  ...
  Future<void> expectBuildPortShortcutEmits(
    ...
    expect(
      ...
      findsOneWidget,
      reason:
          '$hostLabel must render an enabled Build port inline action '
    ...
    expect(
      ...
      hasLength(1),
      reason:
          'Tapping the enabled Build port shortcut must open the '
    ...
    expect(
      ...
      reason:
          ...
          'Engineer-only panel can assign build_port to that tile.',
    );
      ...
      (WidgetTester tester) async {
        ...
        if (host.wide) {
          ...
          expect(
            ...
            isEmpty,
            reason:
                'A disabled / absent Build port shortcut must never '
