...
//
// Pins colour tiers (muted / accent / danger), details panel copy, and narrow
// viewport popover placement per SPEC/ui/empire-overview.md § Cargo hold.
...
Future<void> _pumpCargoIndicatorGolden(
  WidgetTester tester, {
...
void main() {
  ...
  testWidgets(
    'golden: cargo hold normal tier muted (Refs #4253)',
    (WidgetTester tester) async {
      const boundaryKey = ValueKey<String>('cargo_hold_indicator_normal_golden');
      await _pumpCargoIndicatorGolden(
        tester,
        boundaryKey: boundaryKey,
        used: 3,
        capacity: 12,
  ...
  testWidgets(
    'golden: cargo hold tight tier accent (Refs #4253)',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'golden: cargo hold full tier danger (Refs #4253)',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'golden: cargo hold details panel breakdown (Refs #4253)',
    (WidgetTester tester) async {
  ...
  testWidgets(
    'golden: cargo hold narrow viewport panel open (Refs #4253)',
    (WidgetTester tester) async {
      const boundaryKey = ValueKey<String>(
        'cargo_hold_narrow_viewport_golden',
      );
