...
String sampleUnitIdFromEventFeedHarness(EventFeedHarness harness) {
  if (harness.game.worldState.oldWorld.units.isNotEmpty) {
    return harness.game.worldState.oldWorld.units.first.id;
  }
  if (harness.game.worldState.newWorld.units.isNotEmpty) {
    return harness.game.worldState.newWorld.units.first.id;
  }
