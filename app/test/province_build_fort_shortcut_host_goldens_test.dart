...
class _GameServiceBuildFortGolden extends GameService {
  _GameServiceBuildFortGolden(super.box, super.adapter);
    ...
    players: [
      Player(
        ...
        stockpile: const Stockpile(
          quantities: {'lumber': 10, 'bronze': 10},
        ),
      ),
    ],
    minorNations: const [],
...
PerPlayerWorkTargetSelectionCache _buildSelectionCache({
  ...
  cache.refresh(
    WorkTargetSelectionSnapshot(
      ...
      tileMapByRegion: _GameServiceBuildFortGolden._tileMapByRegion,
    ),
  );
  return cache;
}
...
void main() {
  ...
  setUpAll(() async {
    Hive.init('./.dart_tool/test_hive_province_bf_golden');
      ...
      wrapGoldenBoundary(
        ...
        overrides: [
          ...
          gameServiceProvider.overrideWith(
            (ref) =>
                _GameServiceBuildFortGolden(gamesBox, GameSaveAdapter()),
          ),
