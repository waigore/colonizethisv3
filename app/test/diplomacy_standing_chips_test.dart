...
void main() {
  ...
  group('diplomaticStandingChips derivation', () {
    ...
    test(
      ...
      () {
        final game = diplomacyStandingBoycottedByGame();
        final chips = diplomaticStandingChips(
          game: game,
          humanPlayerId: 'gp1',
          factionId: 't2',
    ...
    test('Minor at Join Empire stage yields a Join Empire chip', () {
      final game = diplomacyStandingMinorJoinEmpireGame();
      final chips = diplomaticStandingChips(
        game: game,
        humanPlayerId: 'gp1',
        factionId: 'm1',
    ...
    test('AC: overseas holdings reflect human tile count and rounded share', () {
      final game = diplomacyStandingOverseasGame();
    ...
    test('Negative: discovered faction with no standing reports isEmpty', () {
      final game = diplomacyStandingEmptyGame();
      final chips = diplomaticStandingChips(
        game: game,
        humanPlayerId: 'gp1',
        factionId: 'm1',
