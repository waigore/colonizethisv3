...
// (Refs #4013). Lives outside `app/test/support/` so scenario-heavy GameScreen
// hosts do not count toward `repo.app_test_support_loc`. Re-exported from
// `app/test/support/game_screen_test_support.dart`.
