...
void main() {
  ...
  group('SPEC/ui/mobile-adaptation.md § 7 — CallToArmsDialogueOverlay @ '
    ...
    Game ctaGame() => buildThreeGpDialogueOverlayGame(id: 'cta_320');
    ...
    testWidgets('AC (positive) CallToArmsDialogueOverlay (one pending call) @ '
    ...
    testWidgets('AC (positive) CallToArmsDialogueOverlay (two pending calls) @ '
