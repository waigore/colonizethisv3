// Map area widget and state cluster. SPEC/ui/province-sea-zone-detail-overlay.md.
//
// De-parted wave-9 cluster (Refs #4117): explicit-import mixin libraries replace
// the former 14-part library. Public surface: [GameMapArea].
