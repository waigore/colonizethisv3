// Region minimap widget. SPEC/ui/empire-overview.md § Region minimap.
//
// De-parted wave-9 cluster (Refs #4117): explicit-import libraries replace the
// former 5-part library. Public surface: [GameRegionMinimap].
...
import 'game_region_minimap_toggle_button.dart';
...
class GameRegionMinimap extends ConsumerWidget {
  ...
  /// See [kGameRegionMinimapPanelPadding].
  static const double panelPadding = kGameRegionMinimapPanelPadding;
