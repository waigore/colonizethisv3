...
import 'province_detail_overlay_host_support_sail_move.dart';
...
({
  ...
  ProvinceTrainNavalOverlayControls trainNaval,
...
buildProvinceDetailMissionOverlayControls({
  ...
  return (
    ...
    trainNaval: buildProvinceTrainNavalOverlayControls(
      game: game,
      region: region,
      humanPlayerId: humanPlayerId,
      playerView: playerView,
    ...
    navalCombine: buildProvinceNavalCombineOverlayControls(
      context: context,
      game: game,
      region: region,
      humanPlayerId: humanPlayerId,
    ...
    sailMove: buildProvinceOverlaySailMoveOverlayControls(
      context: context,
      game: game,
      region: region,
      humanPlayerId: humanPlayerId,
