// Section heading + faction/relation badge chrome for DiplomacyPanel.
// SPEC/ui/diplomacy-panel.md § Section headings, § Per-faction row → Type
// badge colors, and § Relation state badge.
