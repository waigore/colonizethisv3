/// Civilian units panel screen widget. SPEC/ui/civilian-units-panel.md.
///
/// De-parted wave-9 cluster (Refs #4117): explicit-import libraries replace the
/// former part library. Public surface: [CivilianUnitsPanel].
...
/// Panel that lists all civilian units for the human player.
