...
class ResearchFundingBreakdownMetrics extends StatelessWidget {
  const ResearchFundingBreakdownMetrics({
    super.key,
...
class ResearchFundingBreakdownBlockedNotice extends StatelessWidget {
  const ResearchFundingBreakdownBlockedNotice({
    super.key,
    required this.preview,
    required this.l10n,
    required this.theme,
...
class ResearchFundingBreakdownRow extends StatelessWidget {
  const ResearchFundingBreakdownRow({
    super.key,
    required this.label,
    required this.value,
...
String spyInsightBreakdownLabel(
  ...
  return l10n.technologyPanel_rpBreakdownSpyInsightMany(
    joinCourtDisplayNames(names),
    percent,
  );
}

@visibleForTesting
String joinCourtDisplayNames(List<String> names) {
  if (names.length == 2) {
