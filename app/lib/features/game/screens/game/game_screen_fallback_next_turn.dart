...
class _FallbackNextTurnButtonState
    extends ConsumerState<_FallbackNextTurnButton> {
  @override
  Widget build(BuildContext context) {
    ...
    return CtNinePatchButton(
      ...
      onPressed: nextTurnEnabled ? _runFlameCanvasFallbackNextTurn : null,
  ...
  Future<void> _runFlameCanvasFallbackNextTurn() async {
