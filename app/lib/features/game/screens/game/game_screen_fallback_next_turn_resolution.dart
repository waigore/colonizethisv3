...
/// Runs isolate-backed turn resolution for the Flame-canvas fallback path
/// (when [mapViewDataProvider] is null).
Future<void> _runFlameCanvasFallbackNextTurn({
  ...
  unawaited(
    showDialog<void>(
      ...
      builder: (_) => ValueListenableBuilder<String>(
        ...
        builder: (_, text, _) => TurnResolutionProcessingDialog(phaseText: text),
      ),
    ).whenComplete(() {
