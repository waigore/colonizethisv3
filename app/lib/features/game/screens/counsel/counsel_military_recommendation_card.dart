...
final class CounselMilitaryCallbacks {
  const CounselMilitaryCallbacks({this.onAgreeTrain, this.onAgreeInvade});
...
class CounselMilitaryCardTitleRow extends StatelessWidget {
  const CounselMilitaryCardTitleRow({
    super.key,
    required this.title,
    required this.highlighted,
...
class CounselMilitaryCardDetailLines extends StatelessWidget {
  const CounselMilitaryCardDetailLines({
    super.key,
