...
/// for [TradeScreen]. Split into a library part so the host screen file stays
/// under the repo file-size target without changing the public
/// `TradeScreen.*` static API surface used by widget tests.
