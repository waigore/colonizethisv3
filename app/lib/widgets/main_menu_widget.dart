// Main menu screen widget. SPEC/ui/main-menu.md; UXD 03a.
//
// De-parted wave-9 cluster (Refs #4117): explicit-import libraries replace the
// former 8-part library. Public surface: [CtMainMenu], [MainMenuVariant],
// [MainMenuState].
...
class CtMainMenu extends StatelessWidget {
  ...
  Widget _buildLogo(BuildContext context) {
    ...
    return MainMenuPixelArtLogoRegion(title: appL10n(context).mainMenu_title);
  }
}
