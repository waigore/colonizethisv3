...
/// Ratcheted after wave-9 slice F game-screen / draft-orders / yarn /
/// state-logic fixture relocate outside support tree (Refs #4117).
const int appTestSupportLocCeiling = 2261;
