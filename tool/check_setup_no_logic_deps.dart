// Forbids production imports of colonizethis_logic from colonizethis_setup (Refs #3290 Phase 2).
import 'dart:io';
...
void main() {
  exit(runCheckSetupNoLogicDeps(Directory.current.path));
}

int runCheckSetupNoLogicDeps(
  String repoRoot, {
  void Function(String line)? err,
}) {
  final logE = err ?? stderr.writeln;
  final libDir = Directory(p.join(repoRoot, _setupLibRelative));
  if (!libDir.existsSync()) {
    logE('check_setup_no_logic_deps: missing $_setupLibRelative');
    return 1;
  }
