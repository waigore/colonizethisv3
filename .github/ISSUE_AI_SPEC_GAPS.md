...
## 4. Dialogue and mood — **PARTIAL** (diplomatic + event battle + event era change + mood state machine + base mood)
...
**Missing:**  
- Emit dialogue on reactive/negotiation (reactive banter, negotiation lines) with correct category/situation/era/variables.
