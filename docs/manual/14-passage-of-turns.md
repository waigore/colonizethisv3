...
5. `DLG60001` **Next turn confirmation** opens. The title is **End turn?** or **Proceed to next turn?** The body says **Turn {N} will end. Continue?**
...
9. Tap go-to on a listed civilian to leave without ending the turn. The map finds that person and opens `UNIT10001` **Civilian units panel**. A **Spy** is a civilian posted in a foreign court or at home; Spies are **not** listed here — foreign station, home counter-spy, and capital reserve are deliberate posts, not wasted capacity.
...
1. When a technology finishes researching, its feed line shows the tech by name and up to two short lines that say what the unlock does (the same plain wording as **Choose tech**). Tap it to open `GAME40001` **Technology screen** on the Slots tab and choose your next project.
...
- [ ] Explains the map tab-bar coin tap: current gold, Next-turn forecast, committed gold lines, Exact/Compact inside the panel, and that unused research seats and Spies are omitted.
