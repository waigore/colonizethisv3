...
- Switch maps with the **Old World** / **New World** tabs on `MAP10001` **Empire overview / map area**. The small map in the bottom-right only moves the camera on the map you are already viewing.
