...
2. `MAP20001` **Province sea-zone overlay** opens. The header reads **Province** or **Sea zone**. Political lists **Name**, **Owner**, standing with that court when your records know them (**At war** or **At peace**, plus **ALLIANCE** when you hold a formal treaty), **Sight**, **Region**, and whether the place is a capital.
...
7. You can also right-click a tile (or press and hold on a touch screen) to open `MAP30001`, a small ring of nearby actions, without opening that panel first. The ring can show **Explore**, **Prospect**, **Build improvement**, **Build road**, **Purchase land**, **Upgrade town**, **Build port**, **Build railroad**, and **Build fort** when those shortcuts belong on the tile (they may be greyed with a reason). At most five actions sit on the ring; the rest land under **More**. **More** always includes **Province details**. On a tight screen the ring is skipped and `MAP30002` **More tile actions** opens instead.
...
After a turn resolves, when turn news closes (or after **View Final State** on `OVL20001` **Victory overlay**, including **Campaign complete**), `MAP10001` may pulse a few last-turn fights, captures, finished works, or discoveries so you see where the realm changed; Chapter 14 covers skip and the full feed.
