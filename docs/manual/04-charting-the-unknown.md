...
3. When that work **finishes**, after you confirm **Next turn**, every tile in that province becomes **Fully visible** for you. `OVL70001` **Player turn event feed** says `{province} work completed! This province is now fully visible.` Last-turn highlight captions on `MAP10001` use the same line.
