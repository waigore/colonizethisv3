...
2. The map area is `MAP10001` **Empire overview / map widget**: pan, zoom, region tabs (Old World / New World), and selection of provinces and sea zones. When resource icons are on, a small **extraction-disc legend** near the bottom-left map tools teaches gold vs brown disc colours (Chapter 3). When **Show improvements** is on, owned improved tiles show **1 of 1** / **1 of 2** marks and a matching teaching chip (Chapter 3).
