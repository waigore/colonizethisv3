...
| Set Subsidy | Embassy; Minor/Tribe only; 5–20% in steps of 5. `DIPL20001` **Submit** stages the pending subsidy (no second confirmation). | No treasury charge; on fills with that court you pay the subsidy percent more when buying and receive that percent less when selling. |
