...
| Build ship | `UNIT30001` **Naval units panel** → **Train** → `UNIT60001` **Train Naval** (each row shows role, cargo or combat gist, food upkeep per turn, and build costs). | Treasury, materials, one reserved peasant, and ship technology where required. | While work finishes after Next turn; joins Home Fleet | Ch. 13 |
