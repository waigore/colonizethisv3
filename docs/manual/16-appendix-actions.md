...
| Purchase land — Merchant | Embassy, peace, tile in a **Minor or Tribe** province that has a resource (not Great Power land, not your own); if the resource is a mineral, the tile must already be prospected; treasury ≥ 15× base price; not already purchased by any Great Power. **`MAP20001` Purchase land** and **`MAP30001` Purchase land** open Merchant-only assignment for the selected tile when eligible. Enabled controls show the payoff gist (first bid / overseas gold on tradeable sales, or riches into your treasury; land stays the court’s) beside the £ cost. | One-turn completion debits treasury and records the tile purchase. Privileges start when that work finishes. |
