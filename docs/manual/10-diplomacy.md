...
1. On `GAME10001` **Game screen**, tap the **Diplomacy** icon on the left of the map. That opens `GAME30001` **Diplomacy screen**.
...
3. Tap a row to open `GAME30002` **Diplomacy detail screen**. You see three cards: **CURRENT RELATION** (Great Powers also show **Relative power:**, an **ALLIANCE** chip when a treaty exists, standing chips, and a **Formal allies** line), **DIPLOMATIC HISTORY** (newest first, with year and turn; undiscovered parties appear as **Unknown faction**), and **DOSSIER** (Great Powers only — suspicion and evidence, never a secret label). This screen does not issue decrees; actions stay on `GAME30001`.
4. On `GAME30001`, tap **Intelligence**. That opens `GAME30003` **Intelligence Council**. **World briefing** lists last turn’s public wars, peace, formal alliances formed or broken, overture advances, captures, discoveries, and first fleet presence. When there is nothing to report, it shows **No major world events last turn.** **Spy reports** lists news from courts where one of your Spies still stood after the turn finished; each line starts **Our spy in {court} reports:**. When you have no Spies abroad, it shows **No spy reports. Station a Spy in a foreign province to hear that court's news.** Closing turn news does not erase this briefing; it stays until the next turn replaces it. Tap a court line to open `GAME30002`. Tap a capture or discovery line to open that place on the map via `MAP20001` **Province sea-zone overlay** (Political is the tab).

### Stage a decree on a court

5. On each `GAME30001` row, tap an enabled action. Actions that need no amount still open a confirm that names **Cost**, **Effect**, and — for **Break Alliance** only — **When**. **Grant Aid** and **Set Subsidy** show **Cost** and **Effect** on `DIPL20001` **Grant or subsidy dialog**; **Submit** stages the action with no second confirm. Tap **More actions** for unavailable steps and the refusal reason under each.
6. On `MAP20001` **Province sea-zone overlay**, Political shows standing with the owner when your records know them (**At war** or **At peace**, plus **ALLIANCE** when you hold a formal treaty). It can also show **No consulate with {owner}** plus **Establish Consulate** when Explore or Prospect is blocked for lack of a Consulate. The disabled Explore/Prospect hint is **Establish a consulate before exploring or prospecting**. After you hold a Consulate and not an Embassy, Political offers **Establish Embassy** while you are at peace with that Minor Nation or Tribe. Disabled **Purchase land** still names Embassy; on a narrow screen the hint also says to use **Establish Embassy** on Political. After you hold an Embassy with a Minor Nation or Tribe and you are at peace, Political also offers **Grant Aid** and **Set Subsidy** — the same names as on `GAME30001`. Those two open `DIPL20001` **Grant or subsidy dialog** from the map; **Submit** there stages the decree, and a pending grant or subsidy on Political becomes **Cancel**. When you are **At war** with that owner on a foreign land province, Political also offers **Offer Peace**. Consulate, Embassy, and Offer Peace use the same confirm, pending order, and **Cancel** behavior as the Diplomacy row.
...
10. **Break Alliance** requires that treaty. On the human panel it ends immediately after confirmation rather than waiting for **Next turn**. A voluntary break harms standing with the former ally and with other courts the same way a refused call to arms does. The confirm on `GAME30001` names the rest-of-turn lock (Alliance, overture, Favored Trading Partner, Grant Aid, and Set Subsidy blocked toward that court until next turn; Declare War and Offer Peace stay available) and does not print the −50 / −10 figures; those numbers appear on `OVL40001` **Call to arms dialogue overlay** under **Refuse**.
...
12. Tap **Establish Overture**. The stage dialog opens first. The enabled next stage sits on the default row; later locked stages sit under **More actions** with the refusal reason. Then the confirm appears and names what that stage unlocks (for example, a Consulate toward a Minor or Tribe lets you Explore and Prospect on their land; an Embassy opens Grant Aid, subsidies, and land purchase; a Non-Aggression Pact does not by itself stop you from declaring war; **Join Empire** names absorb vs colony in plain words — see step 17). **Confirm** stages the pending decree. Stages advance one at a time: Trade Consulate, Embassy, Non-Aggression Pact, then Join Empire. You may submit only one overture toward a faction per turn.
...
15. Minor Nations never refuse Consulate or Embassy. Join Empire toward a Minor or Tribe still needs Friendly/Allied standing and the treasury cost. Great Power targets decide for themselves; when you are the target, `OVL30001` **Overture dialogue** asks you to answer.
...
17. **Join Empire** follows a Non-Aggression Pact and needs the required standing and treasury. Toward a Minor Nation or Tribe, the default cost is £5000 plus £2000 per province the target owns; the confirm shows that cost as one £ figure. Toward a **Minor Nation**, the confirm says that if they accept the court is absorbed: their land, armies, and fleets become yours and they leave the map. Toward a **Tribe**, the confirm says that if they accept they stay on the map under their own ownership as your **colony**, their land does not become yours, and that land does not count toward the 31 Old World provinces for victory. Against another Great Power, Join Empire requires Empire Building and a nearly defeated target: three or fewer total provinces and loss of its original capital. The confirm says there is no treasury charge and that if they accept they are absorbed — remaining land, armies, and fleets become yours and that court leaves the map. After the turn, history and Intelligence use the same distinction: a Tribe colony is never described as absorbed.
...
19. **Grant Aid** requires an Embassy and enough gold. From `GAME30001`, or from `MAP20001` Political on that court’s land after Embassy, open `DIPL20001`, choose a positive amount in £1000 steps (minimum £1000), read **Cost** and **Effect**, and tap **Submit**. That stages the one-time transfer with no second confirm. **Cost** names the gold that leaves your treasury. **Effect** says standing with that court improves when the turn finishes, that a larger gift this turn does not improve standing further, and whether the standing word on `GAME30001` **stays** the current word or **becomes** the next word. Give the smallest allowed gift unless you simply want to spend the gold. Tap **Cancel** on the `GAME30001` row or on Political if you change your mind before **Next turn**.
20. **Set Subsidy** uses the same `DIPL20001` dialog, from `GAME30001` or from `MAP20001` Political after Embassy. It is available only toward a Minor Nation or Tribe with an Embassy (not toward another Great Power). Choose 5%, 10%, 15%, or 20%. **Cost** says there is no per-turn gold charge. **Effect** says that on deals that fill with that court you pay that percent more when buying from them and receive that percent less when selling to them. Hover or long-press the outgoing or pending subsidy line on `GAME30001` for the same meaning. **Submit** stages the subsidy with no second confirm.
...
- A successful Minor Nation Join Empire directly expands your realm — the confirm and later history say the court is absorbed. For how Old World province counts feed victory, see Chapter 15. A Tribal Join Empire creates a colony instead: the confirm and later reports say their land stayed theirs, so it is strategically valuable but not direct province ownership.
...
- [x] Documents **Declare War**, **Offer Peace**, **Alliance**, **Break Alliance**, **Establish Overture**, **Grant Aid**, **Set Subsidy**, **Boycott**, and **Revoke Boycott**.
...
- [x] States that after Embassy, `MAP20001` Political offers **Grant Aid** and **Set Subsidy** toward that Minor Nation or Tribe at peace, opening the same `DIPL20001` dialog.
