...
6. On `MAP20001` **Province sea-zone overlay**, Political can show **No consulate with {owner}** plus **Establish Consulate** when Explore or Prospect is blocked for lack of a Consulate. The disabled Explore/Prospect hint is **Establish a consulate before exploring or prospecting**. That Consulate control uses the same confirm and **Cancel** as the Diplomacy row. No other diplomacy actions appear there.
