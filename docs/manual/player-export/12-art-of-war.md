...
1. Open **Military units panel**, select a non-Home army, and choose **Move** to open **Move army dialog**.
...
1. When your coming battle needs a choice, **Combat mode choice dialog** names the contested province.
