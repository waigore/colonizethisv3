...
1. From Production Allocation, tap **Counsel** in the header or a starred row’s counsel star to open **Counsel screen** with the Industry tab.
...
Rival Great Powers run an **economy planner** that assigns labour to feasible recipes under the same effective-labour cap, biased by personality and growth stage . Expect industrial rivals to lock feedstock early and to prefer cargo when their agendas lean trader.
