...
2. **Province sea-zone overlay** opens. The header reads **Province** or **Sea zone**. Political lists **Name**, **Owner**, standing with that court when your records know them (**At war** or **At peace**, plus **ALLIANCE** when you hold a formal treaty), **Sight**, **Region**, and whether the place is a capital.
3. On **Tile**, these rows stay visible: coordinates, **Terrain**, the town or capital line when this square is the town or capital (`The town of …` / `…, the capital of …`), resource, **Prospected**, **Improvement**, **Road / railroad** in plain words (**none**, **primitive road**, **improved road**, or **port or railroad**), and civilians.
...
5. When a **Minor Nation** or **Tribe** (peoples you do not play) province bars exploration for lack of a Consulate, Political also offers **Establish Consulate**. After you already hold a Consulate, Political offers **Establish Embassy** while that court is at peace and you do not yet hold an Embassy — so you can unlock **Purchase land** without leaving the map. Unavailable attempts explain what your court still lacks. When you are **At war** with the owner, Political also offers **Offer Peace** (same confirm as the Diplomacy list); a pending offer becomes **Cancel**.
...
7. You can also right-click a tile (or press and hold on a touch screen) to open **Tile context radial**, a small ring of nearby actions, without opening that panel first. The ring can show **Explore**, **Prospect**, **Build improvement**, **Build road**, **Purchase land**, **Upgrade town**, **Build port**, **Build railroad**, and **Build fort** when those shortcuts belong on the tile (they may be greyed with a reason). At most five actions sit on the ring; the rest land under **More**. **More** always includes **Province details**. On a tight screen the ring is skipped and **More tile actions** opens instead.
