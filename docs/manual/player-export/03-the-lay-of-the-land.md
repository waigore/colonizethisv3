...
7. You can also right-click a tile (or press and hold on a touch screen) to open **Tile context radial**, a small ring of nearby actions, without opening that panel first. The ring can show **Explore**, **Prospect**, and **Build improvement** when those shortcuts are on the tile (they may be greyed with a reason). **More** always includes **Province details**. On a tight screen the ring is skipped and **More tile actions** opens instead.
