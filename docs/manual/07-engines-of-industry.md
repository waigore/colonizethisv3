...
- [x] Documents `GAME20001` / `PROD20001` flows: Available (sellable headroom for tradeable goods), labour readiness, Allocation, desired output, bottleneck, Reset, Breakdown columns.
