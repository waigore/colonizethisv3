...
- [ ] Documents the `GAME70001` Victory panel (left-rail entry, OW standings, expandable calendar-end totals, political OW minimap with origin inspect when available, conditions including infinite mode) in plain province-count language.
