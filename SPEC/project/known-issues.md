...
| 2 | Terrain distribution | Percentages of terrain types (plains, forest, hills, etc.) need tuning for better balance. | Map generation, Pass 6; terrain weights/config in colonizethis_data; generator in colonizethis_map. | 2026-02-15 | Tune weights or add explicit target fractions per region. |
