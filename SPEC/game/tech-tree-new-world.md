...
| sugar_industry | Sugar Industry | 3 | large_sugar_plantations | Improves: sugar cane extraction cap to **4**. Prerequisite-only: no additional techs currently depend on this in the current product catalog. |
...
| tobacco_industry | Tobacco Industry | 3 | early_steam_engine, large_tobacco_plantations | Improves: tobacco extraction cap to **4**. Prerequisite-only: no additional techs currently depend on this in the current product catalog. |
...
| cotton_weaving | Cotton Weaving | 1 | discovery_of_cotton | Enables: cloth production from cotton via labour/industry recipes. Unlocks: prerequisite-only in current product catalog (no direct downstream tech dependency yet). |
...
| cotton_gin | Cotton Gin | 3 | large_cotton_plantations, trained_journeymen | Improves: cotton extraction cap to **4**. Prerequisite-only: no additional techs currently depend on this in the current product catalog. |
...
| excessive_fur_harvesting | Excessive Fur Harvesting | 4 | later_steam_engine, riverboats | Improves: furs extraction cap to **4**. Prerequisite-only: no additional techs currently depend on this in the current product catalog. |
...
| improved_food_preservation | Improved Food Preservation | 3 | large_spice_plantations | Improves: spices extraction cap to **4**. Prerequisite-only: no additional techs currently depend on this in the current product catalog. |
