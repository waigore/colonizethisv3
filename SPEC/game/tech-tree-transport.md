...
|----|------|-----|---------------|--------|
| road_construction | Road Construction | 1 | saw_mill, land_enclosure, iron_mining | Allows building road level 2 (2 units/tile); leads to railroads |
...
- **Road level 2:** Engineer can build improved roads (transport level 2) only when Road Construction is researched.
