...
| **Province** | Land region. Id, region id, **owner** (faction id), optional **originalOwnerId** (founding owner at setup; preserved across capture; null on legacy saves). Optional **townTileKey** (tile key of province's town for extraction). Tiles; neighbours from topology. |
