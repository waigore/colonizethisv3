...
- **`GameService`** (`app/lib/core/services/game_service/game_service.dart`) loads/saves games and advances turns. Library parts: `game_service_new_game_setup.dart` (create-new-game entry + bootstrap/finalize), `game_service_new_game_setup_pipeline.dart` (freeform/locked-full-init retry pipelines), `game_service_new_game_setup_maps.dart` (tile-map generation, warp links, persistence), `game_service_turn_resume.dart` (turn resolution, diplomacy resume APIs, bus persistence), and `game_service_turn_trace.dart` (merged trace export).
- **`core/services/debug/`** — ctdev/debug command handlers (`app_event_handler_debug_*.dart` library + parts), shared guard helpers (`debug_command_helpers.dart`), and [`DebugCommandSessionHandler`](../../app/lib/core/services/debug/debug_command_session_handler.dart) (applies debug mutations to the active session without importing feature panels).
...
- **`core/services/region_map/`** — narrow Flame region-map widget binding surface ([`region_map_widget_bindings.dart`](../../app/lib/core/services/region_map/region_map_widget_bindings.dart)) consumed by shared `CtRegionMap` widget.
...
- **`features/shell/new_game_leader_selection_dialog.dart`** — DLG10001 new-game leader picker dialog library: `_NewGameLeaderSelectionDialogStateBase` (shared fields + validation), `_NewGameLeaderSelectionDialogSlots` (slot label + text styles), `_NewGameLeaderSelectionDialogSlotRow` (per-slot nation/leader/profile row + responsive pickers), `_NewGameLeaderSelectionDialogSetupFields` (seed/advanced-start/infinite/terrain/footer). Public widget: `NewGameLeaderSelectionDialog`.
- **`features/shell/new_game_setup_flow.dart`** — SHEL30001 new-game initializing flow (`runNewGameSetupAfterLeaderPick`) with progress/error dialog `part` ([new_game_setup_flow_dialogs.dart](../../app/lib/features/shell/new_game_setup_flow_dialogs.dart): `NewGameSetupProgressView`, `NewGameErrorCard`, async progress dialog host).
...
- **`features/game/widgets/units/naval/`** — naval units panel library ([NavalUnitsPanel](../../app/lib/features/game/widgets/units/naval/naval_units_panel.dart) with `part` files for tree list projection (`naval_units_panel_list.dart`), combine/selection (`naval_units_panel_support_combine.dart`), home-transfer (`naval_units_panel_support_home_transfer.dart`), and dialog openers (`naval_units_panel_support_dialogs.dart`)). Imports [fleet_expansion_tile.dart](../../app/lib/features/game/widgets/panels/fleet_expansion_tile.dart), tree builders from `panels/tree_builders/`, and [GamePanelMixin](../../app/lib/features/game/widgets/panels/game_panel_contract.dart) from `panels/`.
...
- **`features/game/widgets/chrome/`** — Ct-* catalog widget implementations shared by in-game panels and dialogs: hover button mixin ([ct_hover_button.dart](../../app/lib/features/game/widgets/chrome/ct_hover_button.dart)), nine-patch button re-export shim ([ct_nine_patch_button.dart](../../app/lib/features/game/widgets/chrome/ct_nine_patch_button.dart) → source of truth [app/lib/widgets/ct_nine_patch_button.dart](../../app/lib/widgets/ct_nine_patch_button.dart) with state/brackets `part`s), action/danger text buttons, dialog shell, panel, and circular locate button. Flame `GameWidget` embedding lives in `widgets/shell/region_map_game_viewport.dart` so this folder stays free of direct Flame imports in catalog widgets.
- **`features/game/widgets/dialogue/`** — narrative dialogue overlays and shared view chrome: [CtDialogueView](../../app/lib/features/game/widgets/dialogue/ct_dialogue_view.dart) + line/choice body parts, game-start intro ([game_start_intro_overlay.dart](../../app/lib/features/game/widgets/dialogue/game_start_intro_overlay.dart)), overture overlay host + yarn-flow and offer-row `part`s ([overture_dialogue_overlay.dart](../../app/lib/features/game/widgets/dialogue/overture_dialogue_overlay.dart), [overture_dialogue_overlay_flow.dart](../../app/lib/features/game/widgets/dialogue/overture_dialogue_overlay_flow.dart), [overture_dialogue_overlay_offer_row.dart](../../app/lib/features/game/widgets/dialogue/overture_dialogue_overlay_offer_row.dart)), intervention overlay + yarn-flow `part` ([intervention_dialogue_overlay.dart](../../app/lib/features/game/widgets/dialogue/intervention_dialogue_overlay.dart), [intervention_dialogue_overlay_flow.dart](../../app/lib/features/game/widgets/dialogue/intervention_dialogue_overlay_flow.dart)) and extracted choice buttons ([intervention_choice_buttons.dart](../../app/lib/features/game/widgets/dialogue/intervention_choice_buttons.dart)), call-to-arms overlay host + call-row `part` ([call_to_arms_dialogue_overlay.dart](../../app/lib/features/game/widgets/dialogue/call_to_arms_dialogue_overlay.dart), [call_to_arms_call_row.dart](../../app/lib/features/game/widgets/dialogue/call_to_arms_call_row.dart)), tribe first-contact overlay + sync helper. Public imports use full package paths; no barrel re-export shim.
- **`features/game/screens/trade/`** — World Market trade screen library ([TradeScreen](../../app/lib/features/game/screens/trade/trade_screen.dart) with `part` files for widget-test contract aggregator (`trade_screen_contract.dart`), Market contract keys (`trade_screen_contract_market.dart`), Deal Book contract keys (`trade_screen_contract_deal_book.dart`), Market tab body (`trade_screen_market_tab.dart`), cargo header (`trade_screen_market_tab_cargo_header.dart`), order handlers (`trade_screen_market_tab_order_handlers.dart`), catalog/section builders (`trade_screen_market_tab_catalog.dart`), Market row chrome (`trade_screen_market_row.dart`, `trade_screen_market_row_stepper.dart`), and Deal Book ledger (`trade_screen_deal_book.dart`, `trade_screen_deal_book_panel.dart`, `trade_screen_deal_book_rows.dart`)), plus shared Market-tab section callback factory ([trade_section_handlers.dart](../../app/lib/features/game/screens/trade/trade_section_handlers.dart)). Public imports use full package paths; no barrel re-export shim.
