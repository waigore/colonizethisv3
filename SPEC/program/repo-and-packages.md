...
- **`features/game/widgets/panels/`** — in-game order panels: civilian, military, and naval unit panels (with `part` support files), fleet expansion row ([fleet_expansion_tile.dart](../../app/lib/features/game/widgets/panels/fleet_expansion_tile.dart)), pause menu, observe-mode sentinel, and shared [GamePanelMixin](../../app/lib/features/game/widgets/panels/game_panel_contract.dart) contract. Public imports use full package paths; no barrel re-export shim.
