...
- **`features/game/widgets/units/civilian/`** — civilian units panel library ([CivilianUnitsPanel](../../app/lib/features/game/widgets/units/civilian/civilian_units_panel.dart) with `part` files for region list projection (`civilian_units_panel_list.dart`), resolution, row card, and unit row), and sort helpers ([civilian_units_sort.dart](../../app/lib/features/game/widgets/units/civilian/civilian_units_sort.dart)). Imports [GamePanelMixin](../../app/lib/features/game/widgets/panels/game_panel_contract.dart) from `panels/`.
