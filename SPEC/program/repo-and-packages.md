...
- **`features/game/dialogue/`** — narrative dialogue overlays and shared view chrome: [CtDialogueView](../../app/lib/features/game/dialogue/ct_dialogue_view.dart) + line/choice body parts, game-start intro ([game_start_intro_overlay.dart](../../app/lib/features/game/dialogue/game_start_intro_overlay.dart)), overture / intervention / call-to-arms overlays, tribe first-contact overlay + sync helper. Public imports use full package paths; no barrel re-export shim.
