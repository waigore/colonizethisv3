...
- **`features/game/widgets/dialogue/`** — narrative dialogue overlays and shared view chrome: [CtDialogueView](../../app/lib/features/game/widgets/dialogue/ct_dialogue_view.dart) + line/choice body parts, game-start intro ([game_start_intro_overlay.dart](../../app/lib/features/game/widgets/dialogue/game_start_intro_overlay.dart)), overture overlay host + offer-row `part` ([overture_dialogue_overlay.dart](../../app/lib/features/game/widgets/dialogue/overture_dialogue_overlay.dart), [overture_dialogue_overlay_offer_row.dart](../../app/lib/features/game/widgets/dialogue/overture_dialogue_overlay_offer_row.dart)), intervention overlay + yarn-flow `part` ([intervention_dialogue_overlay.dart](../../app/lib/features/game/widgets/dialogue/intervention_dialogue_overlay.dart), [intervention_dialogue_overlay_flow.dart](../../app/lib/features/game/widgets/dialogue/intervention_dialogue_overlay_flow.dart)) and extracted choice buttons ([intervention_choice_buttons.dart](../../app/lib/features/game/widgets/dialogue/intervention_choice_buttons.dart)), call-to-arms overlay host + call-row `part` ([call_to_arms_dialogue_overlay.dart](../../app/lib/features/game/widgets/dialogue/call_to_arms_dialogue_overlay.dart), [call_to_arms_call_row.dart](../../app/lib/features/game/widgets/dialogue/call_to_arms_call_row.dart)), tribe first-contact overlay + sync helper. Public imports use full package paths; no barrel re-export shim.
