...
| Budget | At most **7** physical source lines (total) outside the excluded file may contain a matching `Map<String, Unit> unitsById` function-parameter declaration. |
