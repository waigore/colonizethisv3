...
Other scoring sites (economy colonial pressure, goal floors, colonial-pressure minimum weight) still use the Phase 2 boolean resolvers until their Phase 3 slices land. Hard structural suppression for planner-module dispatch (which modules run per phase) remains unchanged in this slice.
