...
- `app/test/move_dialogs_specs_army_test.dart` / `move_dialogs_specs_fleet_test.dart` — pin army/fleet consumer dialogs over this chrome (section labels, confirm/cancel, declare-war flow, locate).
