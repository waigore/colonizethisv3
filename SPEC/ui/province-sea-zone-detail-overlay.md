...
- **Economic grouping:** Rows bucketed by visible resource; improved → improvable → terrain-only prospect; no coordinates in row text; hover unchanged.
