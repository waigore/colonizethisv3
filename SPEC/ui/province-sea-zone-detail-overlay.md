...
- **Explore cache policy:** UI decisions use a dedicated per-turn explore eligibility cache refreshed on turn-resolution boundaries; overlay rebuild churn must not recompute eligibility.
