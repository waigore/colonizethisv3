...
**SPEC/ui** — Land armies + naval fleets panel. Implementation: `app/lib/features/game/widgets/units/military/military_units_panel.dart`.
...
- **Train button:** Header **Train** closes panel and emits `OpenDialogEvent(trainMilitaryDialogId)` for [train-military-dialog.md](train-military-dialog.md). Additional open: `MAP20001` Military **Train** on the human capital leaves the overlay mounted (Refs #4769).
