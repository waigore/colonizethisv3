...
- **Given** the Map display options dialog is visible for the first time in a game session, **then** the dialog shows **Show resources**, **Show improvements**, **Show roads and rails**, **Show province and sea borders**, **Show province ownership**, and **Show province names**, with all except **Show province ownership** in the ON state.
