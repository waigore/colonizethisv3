...
- **Given** a sea-going fleet is in port at a marker, **when** the player taps the marker (after optional `DLG31003`), **then** the UI layer opens `DLG30001` and does not open `DLG31001`.
