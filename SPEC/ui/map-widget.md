...
- **Given** global observe (`ShellPlayerContext.panelPlayerId == null`), **when** the map builds view data, **then** `capitalLinkDisconnected` remains false on all cells (Refs #4370).
