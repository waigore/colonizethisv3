...
| `SHEL40001` | Pause menu panel | [pause-menu-panel.md](pause-menu-panel.md) | TBD | Pause Menu Panel | active |
...
| `GAME30002` | Diplomacy detail screen | [diplomacy-detail-screen.md](diplomacy-detail-screen.md) | `app/lib/features/game/screens/diplomacy_detail_screen.dart` | Diplomacy Detail Screen | draft |
...
| `GAME50001` | Game side menu | [game-side-menu.md](game-side-menu.md) | TBD | Game Side Menu | active |
...
| `UNIT40001` | Train civilians dialog | [train-civilians-dialog.md](train-civilians-dialog.md) | TBD | Train Civilians Dialog | active |
| `UNIT50001` | Train military dialog | [train-military-dialog.md](train-military-dialog.md) | TBD | Train Military Dialog | active |
| `DIPL20001` | Grant or subsidy dialog | [grant-or-subsidy-dialog.md](grant-or-subsidy-dialog.md) | TBD | Grant or Subsidy Dialog | active |
| `PROD20001` | Production commodity breakdown dialog | [production-commodity-breakdown-dialog.md](production-commodity-breakdown-dialog.md) | TBD | Production Commodity Breakdown Dialog | active |
| `CMPT10001` | Combat mode choice dialog | [combat-mode-choice-dialog.md](combat-mode-choice-dialog.md) | TBD | — | draft |
...
| `CMPT50001` | Quick battle result dialog | [quick-battle-result-dialog.md](quick-battle-result-dialog.md) | TBD | — | draft |
...
| `DLG50001` | Turn news dialog | [turn-news-dialog.md](turn-news-dialog.md) | TBD | Turn news | active |
