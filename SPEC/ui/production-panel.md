...
- `CtSectionLabel`, `CtResourceCell` — `app/lib/widgets/` (Available subpanel headings and resource/worker cells; see `SPEC/ui/pixel-art-ui-catalog.md` § Editorial-monocle palette and `Refs #2859` S10/R10 for the dark-theme contract).
