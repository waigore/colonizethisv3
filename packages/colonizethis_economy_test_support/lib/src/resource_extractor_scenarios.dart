...
ResourceExtractorScenario _extractorRow({
  ...
  refs: refs,
  verify: (result) => assertResourceExtractorExpectation(result, expect),
);
...
/// (Refs #3939 slice 57 — formerly one-shot factories).
