...
const List<PriceDiscoveryNextPriceScenario> priceDiscoveryNextPriceScenarios = [
  (
    label: 'zero volume returns oldPrice unchanged',
    oldPrice: 100.0,
    basePrice: 100,
    newBidQuantity: 0,
    newOfferQuantity: 0,
  ...
  (
    ...
    newBidQuantity: 20,
    newOfferQuantity: 10,
    expectedPrice: 100.0 * (1.0 + 1.0 / 6.0),
    tolerance: 1e-9,
    refs: null,
  ),
  (
    label: 'extreme bid (1000 vs 0) caps delta at +0.20 -> 120.0',
    oldPrice: 100.0,
    basePrice: 100,
    newBidQuantity: 1000,
    newOfferQuantity: 0,
  ...
  (
    label: 'extreme offer (0 vs 1000) caps delta at -0.20 -> 80.0',
    oldPrice: 100.0,
    basePrice: 100,
    newBidQuantity: 0,
  ...
  (
    label: 'floor clamp: oldPrice 32 with base 100 stays at 30.0',
    oldPrice: 32.0,
    basePrice: 100,
    newBidQuantity: 0,
    newOfferQuantity: 1000,
  ...
  (
    label: 'floor clamp: oldPrice 30 (already at floor) stays at 30.0',
    oldPrice: 30.0,
    basePrice: 100,
    newBidQuantity: 0,
    newOfferQuantity: 1000,
  ...
  (
    label: 'zero oldPrice (defensive) recovers to floor on positive volume',
    oldPrice: 0.0,
    basePrice: 100,
    newBidQuantity: 5,
    newOfferQuantity: 5,
  ...
  (
    label: 'balanced bid==offer keeps oldPrice (delta = 0)',
    oldPrice: 50.0,
    basePrice: 50,
    newBidQuantity: 7,
    newOfferQuantity: 7,
  ...
  (
    label: 'negative-leaning ratio applies symmetric formula',
    oldPrice: 100.0,
    basePrice: 100,
    newBidQuantity: 10,
    newOfferQuantity: 20,
...
typedef PriceDiscoveryMarketActivityScenario = ({
  String label,
  double oldPrice,
  int basePrice,
  int newBidQuantity,
...
List<PriceDiscoveryMarketActivityScenario> priceDiscoveryMarketActivityScenarios() =>
  ...
  (
    label: 'zero volume yields 0 priceChangePercent',
    oldPrice: 100.0,
    basePrice: 100,
    newBidQuantity: 0,
    newOfferQuantity: 0,
  ...
  (
    label: 'zero oldPrice (defensive) yields 0 priceChangePercent',
    oldPrice: 0.0,
    basePrice: 100,
    newBidQuantity: 5,
    newOfferQuantity: 5,
  ...
  (
    label: 'returns MarketActivity instance compatible with empty equality',
    oldPrice: 100.0,
    basePrice: 100,
    newBidQuantity: 0,
    newOfferQuantity: 0,
...
void runPriceDiscoveryMarketActivityScenario(
  PriceDiscoveryMarketActivityScenario scenario,
) {
