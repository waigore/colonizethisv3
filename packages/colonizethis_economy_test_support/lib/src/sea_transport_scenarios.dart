...
List<AllocateOverseasToStockpileScenario>
allocateOverseasToStockpileScenarios() => [
  allocateOverseasScenario(
    ...
    pins: (
      ...
      expectEmpty: true,
      expectedTotal: null,
      expectedDelivered: null,
    ),
  ),
  allocateOverseasScenario(
    label: 'cargo cap limits delivered overseas',
    pins: (
      overseas: {'grain': 5, 'timber': 8, 'iron': 4},
      cargoHolds: 10,
      priorityOrder: null,
      expectEmpty: false,
      expectedTotal: 10,
  ...
  allocateOverseasScenario(
    ...
    pins: (
      overseas: {'iron': 20, 'grain': 5},
      cargoHolds: 6,
      priorityOrder: null,
      expectEmpty: false,
      expectedTotal: null,
      expectedDelivered: {'grain': 5, 'iron': 1},
    ),
  ),
  allocateOverseasScenario(
    label: 'custom priorityOrder is respected',
    pins: (
      overseas: {'grain': 3, 'iron': 10},
      cargoHolds: 5,
      priorityOrder: [CommodityCategory.rawMaterial, CommodityCategory.food],
      expectEmpty: false,
      expectedTotal: null,
      expectedDelivered: {'iron': 5, 'grain': null},
    ),
  ),
];
