...
List<BuildCostScenario> buildCostScenarios() => [..._buildCostUnknownUnitScenarios(), ..._buildCostAffordApplyScenarios(), ..._buildCostAffordRejectScenarios()];
List<BuildCostScenario> _buildCostUnknownUnitScenarios() => [buildCostUnknownUnitScenario(label: 'canAffordBuild returns false for unknown unit type', pins: (viaApplyDeduction: false, peasants: 10, treasury: 10000, expectedPeasants: 10, expectedTreasury: 10000)), buildCostUnknownUnitScenario(label: 'applyBuildCostDeduction returns unchanged state for unknown unit type', pins: (viaApplyDeduction: true, peasants: 5, treasury: 1000, expectedPeasants: 5, expectedTreasury: 1000))];
List<BuildCostScenario> _buildCostAffordApplyScenarios() => [buildCostAffordApplyScenario(label: 'civilian Builder: apply matches catalog after canAfford true', pins: (unitType: kUnitTypeBuilder, isMilitary: false, peasants: 10, treasuryPadding: 5000)), buildCostAffordApplyScenario(label: 'military peasant_levies: apply matches catalog after canAfford true', pins: (unitType: 'peasant_levies', isMilitary: true, peasants: 3, treasuryPadding: 500)), buildCostAffordApplyScenario(label: 'naval carrack: apply matches catalog after canAfford true', pins: (unitType: 'carrack', isMilitary: false, peasants: 10, treasuryPadding: 500))];
