...
List<CollectPortTileKeysScenario> collectPortTileKeysScenarios() => [
  (
    ...
    expect: const CollectPortTileKeysExpectation(
      expected: {'oldWorld|harbor|0|0', 'newWorld|harbor|1|1'},
    ),
    refs: '#3939',
  ),
  (
...
List<CapitalFactionLookupScenario> capitalFactionLookupScenarios() => [
  (
    ...
    expect: const CapitalFactionLookupExpectation(
      pins: [
        (factionId: 'gp1', provinceId: 'oldWorld|p1', regionId: 'oldWorld'),
      ],
    ),
    refs: '#3939',
  ),
  (
    ...
    expect: const CapitalFactionLookupExpectation(
      pins: [
        (factionId: 'm1', provinceId: 'oldWorld|m1', regionId: 'oldWorld'),
        (factionId: 't1', provinceId: 'newWorld|t1', regionId: 'newWorld'),
      ],
    ),
    refs: '#3939',
  ),
  (
    ...
    gameBuilder: TestFixtures.minimalGame,
    expect: const CapitalFactionLookupExpectation(
      pins: [(factionId: 'missing', provinceId: null, regionId: null)],
    ),
    refs: '#3939',
  ),
];
