...
/// `ai_victory_config*.dart` modules. Topic-split across military, declare-war,
/// stall/colonial, work, and civilian-build libraries; this facade concatenates
/// them in canonical order.
/// SPEC/ai/ai-parameter-registry.md. Refs #3436, #3794, #4072, #4412.
library;

import 'ai_parameter.dart';
import 'ai_parameter_victory_config_params_civilian_build.dart';
import 'ai_parameter_victory_config_params_declare_war.dart';
