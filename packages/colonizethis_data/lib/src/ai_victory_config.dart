...
const int kDeclareWarBelowObserverQuotaMinorBonus = 120;

/// Regiment build floor when below the observer quota and at war (avoid 0-regiment collapse).
const int kStalledMinRegimentCountWhenBelowObserverQuota = 8;
