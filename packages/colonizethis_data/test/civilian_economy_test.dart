...
void main() {
  group('buildUnitCategoryForUnitType', () {
    test('returns civilian for Builder', () {
      expect(buildUnitCategoryForUnitType('Builder'), BuildUnitCategory.civilian);
    });

    test('returns civilian for Explorer', () {
      expect(buildUnitCategoryForUnitType('Explorer'), BuildUnitCategory.civilian);
    });

    test('returns civilian for Merchant', () {
      expect(buildUnitCategoryForUnitType('Merchant'), BuildUnitCategory.civilian);
    });
  ...
  group('CivilianEconomyCatalog', () {
    ...
    test('Merchant has 2000 cash and 4 paper', () {
      final econ = CivilianEconomyCatalog.byId['Merchant']!;
    ...
    test('unlockingTechByCivilianId has Merchant and Rail Builder', () {
      expect(unlockingTechByCivilianId['Merchant'], 'merchant_companies');
      expect(unlockingTechByCivilianId['Rail Builder'], 'early_steam_engine');
    });
  });
}
