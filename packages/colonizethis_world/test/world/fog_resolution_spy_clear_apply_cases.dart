...
void registerFogResolutionSpyClearApplyCases() {
  group('applyProvinceOwnershipChangeVisibility', () {
    test('fully visible for new owner and downgrades former owner', () {
      ...
      final game = ownershipTransferVisibilityGame(
        provinceId: pid,
        tileKey: tileKey,
        formerOwnerId: 'a',
        newOwnerId: 'b',
  ...
  group('applyCoastalSeaZoneFullVisibility', () {
    ...
    test('slice 16: only ProvinceOwnerCache-owned provinces drive sea-zone '
