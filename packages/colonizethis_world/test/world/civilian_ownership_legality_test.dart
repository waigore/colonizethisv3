...
void main() {
  group('relocateIllegalCiviliansInChangedProvinces', () {
      ...
      return TestFixtures.minimalGame(
        ...
        oldWorld: RegionData(
          provinces:
              ...
              const [
                Province(
                  id: changedProvinceId,
                  regionId: ow,
                  ownerId: 'new_owner',
                ),
                Province(
                  id: unchangedProvinceId,
                  regionId: ow,
                  ownerId: 'new_owner',
                ),
    ...
    test(
      'relocates illegal civilian in changed province and normalizes state',
      () {
        final unit = Unit(
          id: 'u1',
          ...
          currentWork: const CurrentWork(
            // Non-canonical fixture: world tests must not import orders
            // kWorkTarget* (Refs #4515). Relocation clears currentWork.
            workTarget: 'in_progress_work',
            tileKey: changedTile,
            totalTurns: 2,
            remainingTurns: 1,
          ),
    ...
    test(
      'throws hard error when owner capital province cannot be resolved',
      () {
        final unit = Unit(
          id: 'u1',
          type: kUnitTypeBuilder,
