...
import 'connectivity_resolver_gp_sea_extra_cases.dart';
...
void main() {
  group('ConnectivityResolver sea/port', () {
    ...
    test(
      'capital not on seaboard: only ports reachable by road from capital connected',
      () {
  ...
  registerConnectivityResolverGpSeaExtraCases();
}
