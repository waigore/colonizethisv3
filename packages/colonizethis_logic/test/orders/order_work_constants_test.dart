...
import 'package:colonizethis_logic/src/orders/order_work_constants.dart'
    as order_constants;
...
void main() {
  group('order_work_constants ownership (Refs #3290)', () {
    ...
    test(
      ...
      () {
        const repoRelativeSrc = 'lib/src';
        // Tests run from the package root (packages/colonizethis_logic).
        final ownerFile = File(
          '$repoRelativeSrc/orders/order_work_constants.dart',
        );
        final coreFile = File('$repoRelativeSrc/constants.dart');
        expect(
        ...
        expect(
          coreSrc.contains("export 'orders/order_work_constants.dart';"),
          isTrue,
          reason:
