    ...
    () {
      test(
        ...
        () {
          ...
          final result = computeNonGreatPowerAutoOffers(
            game: game,
            tileMapByRegion: {'oldWorld': _singleResourceTileMap(Resource.timber)},
      ...
      test(
        ...
        () {
          ...
          expect(order.originTileKey, equals(purchasedTileKey));
          final attribution = index.attributionForTileKey(
            order.originTileKey!,
          );
      ...
      test(
        ...
        () {
          ...
          expect(
            result,
            isEmpty,
            reason: 'mineral riches are excluded from non-GP auto-offers '
      ...
      test(
        ...
        () {
          ...
          expect(
            result,
            isEmpty,
            reason: 'spices is in richesCommodityIds and is filtered from '
