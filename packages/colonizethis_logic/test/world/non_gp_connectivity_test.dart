...
/// Tests for [resolveNonGreatPowerConnectivity] (Refs #2991 C3 — non-Great-Power
/// capital connectivity). SPEC: SPEC/game/factions.md § Minor and Tribe capital
/// connectivity, SPEC/game/capital-and-connectivity.md § Non-Great-Power capital
/// connectivity.
void main() {
