...
void main() {
  group('AIWorldSnapshot.fromPlayerView', () {
    ...
    test(
      'with topology: neighborProvincesHostile and capitalThreatened when neighbor at war',
      () {
        const r = 'oldWorld';
        final view = _view(
          playerId: 'gp1',
        ...
        final playerWithCapital = view.player.copyWith(
    ...
    test(
      'with topology: weakNeighbors lists faction ids owning adjacent provinces',
      () {
        const r = 'oldWorld';
        final view = _view(
          playerId: 'gp1',
    ...
    test(
      'richUnexploitedProvinces counts unclaimed and others with development',
      () {
        const r = 'oldWorld';
        final view = _view(
          playerId: 'gp1',
        ...
        expect(
          snap.opportunities.richUnexploitedProvinces,
          2,
        ); // unclaimed p3 + gp2's p2 with development
      },
    );
  });
}
