/// Shared fixtures for EXPAND-regime peace unit pins (Refs #3967).
///
/// Owns [ownSnapshot] and the duplicated Game builders
/// ([buildCriticalExpandPeaceGame], [buildDistractionExpandPeaceGame],
/// [buildZeroRegimentExpandPeaceGame], [buildPeerExpandPeaceGame]) so
/// per-decider `*_peace_test.dart` files keep only assertions and
/// decider-specific constants.
library;
