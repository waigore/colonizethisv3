...
import 'package:colonizethis_ai/src/planning/expand_phase_planner.dart'
    show weakHoldingsInvadableBlockerPeaceTargets;
...
void main() {
  ...
  test('criticalOwHoldPeaceTargets peace all GP wars at 6 OW below quota', () {
    final game = Game(
    ...
    expect(criticalOwHoldPeaceTargets(game: game, snapshot: snapshot), ['gp4']);
  });
