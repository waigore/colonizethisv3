...
void main() {
  ...
  test(
    ...
    skip:
        'Partial AC #2509 S10 / #2847: seed-42 turn-100 gate — gp1/gp2/gp6 '
        'PASS (gp1 +6, gp2 +6, gp6 +10). gp3 +2, gp4 +1, gp5 -7 FAIL (S7-D '
        'diagnostic refresh 2026-06-07, origin/dev @ 424b3a938). Surface '
        'shifted vs the 2026-06-06 note: gp6 now clears the gate (reaches '
        'COLONIAL 45 turns, +10 OW) while gp5 REGRESSED to -7 — it never '
