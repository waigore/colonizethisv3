// Orchestrator-level cooldown pins for diplomacy planner (Refs #4669 Slice D densify).
...
void registerDiplomacyPlannerCooldownsOrchestratorCases() {
  group('diplomacy planner cooldowns — orchestrator', () {
