...
void main() {
  group('planExpandPeace', () {
    ...
    test(
      'sole GP blocker, mutual-plateau, GP-only frontier, no minors -> '
      'peace the lone GP (carve-out fires)',
      () {
    ...
    test(
      'sole GP blocker, mutual-plateau, GP-only frontier, minors remain '
    ...
    test(
      'sole GP blocker, mutual-plateau, but minor owns invadable OW '
    ...
    test(
      'sole GP blocker, NOT mutual-plateau (partner=10, at quota) '
    ...
    test('mixed GP + non-GP atWarWith with blocker -> only GPs minus blocker', () {
