...
void registerExpandPeaceScalarPredicateMutualPlateauCases() {
  group('isMutualBelowQuotaPlateauPeer (truth table)', () {
    ...
    final cases = <({String name, int ownOw, int partnerOw, bool expected})>[
      ...
      (
        name: 'both at quota minus 2 (8/8)',
        ownOw: 8,
        partnerOw: 8,
        expected: true,
      ),
      (
        name: 'quota minus 2 vs minus 1 (8/9)',
        ownOw: 8,
        partnerOw: 9,
        expected: true,
      ),
      (
        name: 'symmetry 9/8 mirrors 8/9',
        ownOw: 9,
        partnerOw: 8,
        expected: true,
      ),
      (
        name: 'both at upper stall edge (9/9)',
        ownOw: 9,
        partnerOw: 9,
        expected: true,
      ),
      ...
      (
        name: 'ownOw 0 below band (0/8)',
        ownOw: 0,
        partnerOw: 8,
        expected: false,
      ),
      (
        name: 'partnerOw 0 below band (8/0)',
        ownOw: 8,
        partnerOw: 0,
        expected: false,
      ),
      ...
      (
        name: 'partnerOw at quota (9/10)',
        ownOw: 9,
        partnerOw: 10,
        expected: false,
      ),
      (
        name: 'both above quota (12/12)',
        ownOw: 12,
        partnerOw: 12,
        expected: false,
      ),
      (
        name: 'ownOw quota+1 vs quota (11/10)',
        ownOw: 11,
        partnerOw: 10,
        expected: false,
      ),
      ...
      (
        name: 'gap 8 across full band (1/9)',
        ownOw: 1,
        partnerOw: 9,
        expected: false,
      ),
    ...
    test('repeated invocation on same inputs is bit-identical', () {
      ...
      for (final pair in samples) {
        ...
        expect(
          ...
          second,
          reason:
              'pure-int predicate must be stable for ${pair[0]}/${pair[1]}.',
        );
      }
    });
