...
void registerExpandPeaceGamePredicatePivotTruthCases() {
  runExpandPeaceMatrixPredicateCases('canPivotFromSoleGpWarAfterPeace (truth table)',
      canPivotFromSoleGpWarAfterPeace, <ExpandPeaceMatrixPredicateCase>[
    ExpandPeaceMatrixPredicateCase(
      ...
      owProvinces: oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp1, kObserverConquestMinOwProvincesPerGp, start: 1),
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      players: expandPeaceMatrixGp1Gp2,
      playerId: expandPeaceMatrixGp1,
      owProvinces: oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp1, kObserverConquestMinOwProvincesPerGp + 5, start: 1),
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      playerId: expandPeaceMatrixGp1,
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp1, 8, start: 1),
        const Province(
      ...
      minorNations: const [MinorNation(id: expandPeaceMatrixMinor1, displayName: 'M1')],
      ow: 8,
      atWarWith: const [expandPeaceMatrixGp2],
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      players: expandPeaceMatrixGp1Gp2,
      playerId: expandPeaceMatrixGp1,
      owProvinces: oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp1, 8, start: 1),
      nwProvinces: const [
        Province(
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp1, 8, start: 1),
        ...oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp2, 3, start: 1),
      ],
      ow: 8,
      atWarWith: const [expandPeaceMatrixGp2],
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      players: expandPeaceMatrixGp1Gp2,
      playerId: expandPeaceMatrixGp1,
      owProvinces: oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp1, kObserverConquestMinOwProvincesPerGp - 1, start: 1),
