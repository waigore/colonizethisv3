...
void main() {
  group('resolvePhaseEconomyExpandBelowQuotaPeaceInsufficientRegimentsActive', () {
    test('active under EXPAND and COLONIAL-lite when peace + small-regiment '
        '+ invadable arms hold', () {
    ...
    test('suppressed under COLONIAL and DEVELOP even when peace + '
    ...
    test('suppressed when at war with any Great Power (legacy parity)', () {
    ...
    test('suppressed when regimentCount == 0 (legacy parity — zero-regiment '
    ...
    test('suppressed when regimentCount >= kBelowQuotaPeaceMin... '
    ...
    test('reads only the documented inputs — populated sibling slots on '
    ...
    test('field-equal to legacy isBelowQuotaPeaceInsufficientRegiments under '
      ...
      final outcome = PhasePlanOutcome(phase: phase);
      for (var ow = 0; ow < kObserverConquestMinOwProvincesPerGp; ow++) {
  ...
  group('resolvePhaseEconomyExpandBelowQuotaPeaceZeroRegimentsRebuildActive', () {
    test('active under EXPAND and COLONIAL-lite when '
    ...
    test('suppressed under COLONIAL and DEVELOP even when '
        'regimentCount == 0 + invadable arms hold', () {
      for (final phase in <ObserverGoalPhase>[
        ObserverGoalPhase.colonial,
        ObserverGoalPhase.develop,
    ...
    test('suppressed when regimentCount > 0 (legacy parity)', () {
      const outcome = PhasePlanOutcome(phase: ObserverGoalPhase.expand);
      expect(
        resolvePhaseEconomyExpandBelowQuotaPeaceZeroRegimentsRebuildActive(
          phasePlan: outcome,
    ...
    test('suppressed when no invadable provinces (legacy parity)', () {
      const outcome = PhasePlanOutcome(phase: ObserverGoalPhase.expand);
      expect(
        resolvePhaseEconomyExpandBelowQuotaPeaceZeroRegimentsRebuildActive(
          phasePlan: outcome,
    ...
    test('field-equal to legacy isBelowQuotaPeaceZeroRegimentsRebuild '
    ...
    test('mutually exclusive with the insufficient-regiments resolver '
