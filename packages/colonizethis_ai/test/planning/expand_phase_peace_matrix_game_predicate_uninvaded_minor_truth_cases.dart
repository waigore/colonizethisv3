...
void registerExpandPeaceGamePredicateUninvadedMinorTruthCases() {
  runExpandPeaceMatrixPredicateCases('hasUninvadedOldWorldMinor (truth table)',
      hasUninvadedOldWorldMinor, <ExpandPeaceMatrixPredicateCase>[
    ExpandPeaceMatrixPredicateCase(
      name: 'empty minor roster -> false',
      players: expandPeaceMatrixGp1Only,
      playerId: expandPeaceMatrixGp1,
      owProvinces: const [
        Province(id: 'oldWorld|gp1_a', regionId: 'oldWorld', ownerId: expandPeaceMatrixGp1),
      ],
      ow: 0,
      turnNumber: 50,
      expected: false,
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      nwProvinces: const [
        Province(id: 'newWorld|m1_a', regionId: 'newWorld', ownerId: expandPeaceMatrixMinor1),
      ],
      minorNations: const [MinorNation(id: expandPeaceMatrixMinor1, displayName: 'M1')],
      ow: 0,
      turnNumber: 50,
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      owProvinces: const [
        Province(id: 'oldWorld|gp1_a', regionId: 'oldWorld', ownerId: expandPeaceMatrixGp1),
        Province(id: 'oldWorld|m1_a', regionId: 'oldWorld', ownerId: expandPeaceMatrixMinor1),
      ],
      minorNations: const [MinorNation(id: expandPeaceMatrixMinor1, displayName: 'M1')],
      ow: 0,
      turnNumber: 50,
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      owProvinces: const [
        Province(id: 'oldWorld|gp1_a', regionId: 'oldWorld', ownerId: expandPeaceMatrixGp1),
        Province(id: 'oldWorld|m1_a', regionId: 'oldWorld', ownerId: expandPeaceMatrixMinor1),
        Province(id: 'oldWorld|m2_a', regionId: 'oldWorld', ownerId: expandPeaceMatrixMinor2),
      ],
      minorNations: const [
