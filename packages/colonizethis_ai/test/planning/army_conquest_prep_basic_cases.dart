// Basic prepareConquestFieldArmy pins for `army_conquest_prep_test.dart`.
// Single-split and existing-field-army no-op branches.
...
void registerArmyConquestPrepBasicCases() {
