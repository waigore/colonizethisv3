...
import 'army_conquest_prep_stalled_split_cases_tail_cases.dart';

void registerArmyConquestPrepStalledSplitCases() {
  ...
  registerArmyConquestPrepStalledSplitCasesTail();
}
