...
void registerExpandPeaceTargetDeciderQuotaMetCases() {
  runExpandPeaceTargetDeciderMatrixCases('quotaMetFutileBelowQuotaGpPeaceTargets (truth table)',
      quotaMetFutileBelowQuotaGpPeaceTargets, <ExpandPeaceTargetDeciderMatrixCase>[
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp1, kObserverConquestMinOwProvincesPerGp - 1),
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp3, 8),
        const Province(id: 'oldWorld|inv1', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixMinor1),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
      minorNations: const [MinorNation(id: kExpandPeaceMatrixMinor1, displayName: 'M1')],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp1, kObserverConquestMinOwProvincesPerGp + 2),
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp3, 8),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
      minorNations: const [MinorNation(id: kExpandPeaceMatrixMinor1, displayName: 'M1')],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      playerId: kExpandPeaceMatrixGp1,
      ownOw: kObserverConquestMinOwProvincesPerGp + 2,
      atWarWith: const [kExpandPeaceMatrixMinor1, kExpandPeaceMatrixTribe1, kExpandPeaceMatrixGp3],
      invadable: const ['oldWorld|inv1'],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp1, kObserverConquestMinOwProvincesPerGp + 2),
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp2, kObserverConquestMinOwProvincesPerGp),
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp3, 8),
        const Province(id: 'oldWorld|inv1', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixMinor1),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      owProvinces: [
        ...
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp3, 8),
        const Province(id: 'oldWorld|gp2_inv', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixGp2),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
      minorNations: const [MinorNation(id: kExpandPeaceMatrixMinor1, displayName: 'M1')],
      tribes: const [Tribe(id: kExpandPeaceMatrixTribe1, displayName: 'T1')],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      owProvinces: [
        ...
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp3, 8),
        const Province(id: 'oldWorld|gp2_inv_a', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixGp2),
        const Province(id: 'oldWorld|gp2_inv_b', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixGp2),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
      minorNations: const [MinorNation(id: kExpandPeaceMatrixMinor1, displayName: 'M1')],
      tribes: const [Tribe(id: kExpandPeaceMatrixTribe1, displayName: 'T1')],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      playerId: kExpandPeaceMatrixGp1,
      ownOw: kObserverConquestMinOwProvincesPerGp + 2,
      atWarWith: const [kExpandPeaceMatrixGp4, kExpandPeaceMatrixGp2, kExpandPeaceMatrixGp3],
      invadable: const ['oldWorld|inv1'],
      expected: const [kExpandPeaceMatrixGp2, kExpandPeaceMatrixGp3, kExpandPeaceMatrixGp4],
      reason:
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      playerId: kExpandPeaceMatrixGp1,
      ownOw: kObserverConquestMinOwProvincesPerGp + 2,
      atWarWith: const [kExpandPeaceMatrixMinor1, kExpandPeaceMatrixGp4, kExpandPeaceMatrixGp2],
      invadable: const ['oldWorld|inv1'],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      name: 'enters main pass when own OW equals the observer quota '
          '(strict `<` boundary)',
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp1, kObserverConquestMinOwProvincesPerGp),
        ...oldWorldProvincesForExpandPeaceMatrix(kExpandPeaceMatrixGp3, 8),
        const Province(id: 'oldWorld|inv1', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixMinor1),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
