...
import 'phase_planner_colonial_pressure_scaled_bonus_soft_weight_wiring_threshold_cases.dart';
...
const double _earlySprintWeight =
    colonialPressureSoftWeightEarlySprintWeight;
...
void main() {
  ...
  registerPhasePlannerColonialPressureScaledBonusSoftWeightWiringThresholdCases();
}
