...
void registerExpandPeaceTargetDeciderDefaultStartCases() {
  runExpandPeaceTargetDeciderMatrixCases('defaultStartGpPeaceTargets (truth table)',
      defaultStartGpPeaceTargets, <ExpandPeaceTargetDeciderMatrixCase>[
    ExpandPeaceTargetDeciderMatrixCase(
      name: 'not below quota -> empty (OW = quota)',
      owProvinces: const [
        Province(id: 'oldWorld|gp2_a', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixGp2),
      ],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      owProvinces: const [
        Province(id: 'oldWorld|m1_a', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixMinor1),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
      tribes: const [Tribe(id: kExpandPeaceMatrixTribe1, displayName: 'T1')],
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      owProvinces: const [
        Province(id: 'oldWorld|gp1_a', regionId: 'oldWorld', ownerId: kExpandPeaceMatrixGp1),
      ],
      players: kExpandPeaceMatrixDefaultGpRoster,
      tribes: const [Tribe(id: kExpandPeaceMatrixTribe1, displayName: 'T1')],
      playerId: kExpandPeaceMatrixGp1,
    ...
    ExpandPeaceTargetDeciderMatrixCase(
      ...
      playerId: kExpandPeaceMatrixGp1,
      ownOw: kObserverDefaultStartOldWorldProvincesPerGp,
      atWarWith: const [kExpandPeaceMatrixGp2, kExpandPeaceMatrixGp3, kExpandPeaceMatrixGp4],
      invadable: const ['oldWorld|gp2_a'],
