// Build-selection cases for domain_planner_orchestrator_cross_planner_test.dart (Refs #4602).
...
void registerDomainPlannerOrchestratorCrossPlannerBuildCases() {
  test('with strongCargo and ship candidate picks ship deterministically', () {
    ...
    final game = Game(
      ...
      players: const [
        Player(id: 'gp1', displayName: 'A', isHuman: false, leaderKey: 'henry'),
      ],
    );
