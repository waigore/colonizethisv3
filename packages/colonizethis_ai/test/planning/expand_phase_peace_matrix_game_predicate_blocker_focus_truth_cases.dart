...
void registerExpandPeaceGamePredicateBlockerFocusTruthCases() {
  ...
  runExpandPeaceMatrixPredicateCases('isStalledOldWorldGpBlockerFocus (truth table)',
      isStalledOldWorldGpBlockerFocus, <ExpandPeaceMatrixPredicateCase>[
    ExpandPeaceMatrixPredicateCase(
      ...
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp5, kObserverConquestMinOwProvincesPerGp),
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      players: expandPeaceMatrixGp5Gp6,
      playerId: expandPeaceMatrixGp5,
      owProvinces: [...oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp5, 8), expandPeaceMatrixGp6Frontier],
      ow: 8,
      atWarWith: const [expandPeaceMatrixGp6],
      turnNumber: 60,
      expected: false,
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      players: expandPeaceMatrixGp5Gp6,
      playerId: expandPeaceMatrixGp5,
      owProvinces: [...oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp5, 9), expandPeaceMatrixGp6Frontier],
      ow: 9,
      atWarWith: const [expandPeaceMatrixGp6],
      invadable: const ['oldWorld|gp6_frontier'],
      turnNumber: 60,
    ...
    ExpandPeaceMatrixPredicateCase(
      ...
      playerId: expandPeaceMatrixGp5,
      owProvinces: [
        ...oldWorldProvincesForExpandPeaceMatrix(expandPeaceMatrixGp5, kObserverConquestMinOwProvincesPerGp - 1),
        expandPeaceMatrixGp6Frontier,
      ],
