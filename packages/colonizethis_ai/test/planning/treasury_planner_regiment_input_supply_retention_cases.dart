...
void registerTreasuryRegimentInputSupplyRetentionCases() {
  _registerMarketSupplyCases();
  _registerRetentionCases();
  _registerFeedstockCases();
  _registerCastIronLabourFeedstockCases();
}

void _registerMarketSupplyCases() {
...
void _registerCastIronLabourFeedstockCases() {
  group(
