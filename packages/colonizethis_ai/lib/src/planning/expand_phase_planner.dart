...
/// [stalledZeroRegimentAllFactionPeaceTargets] (canonical above).
///
...
/// [mutualExhaustedBelowQuotaGpStalematePeaceTargets] (canonical below)
/// covers the same stalemate at non-zero but critically low regiment
/// counts. Multi-GP wars defer to [multiFrontNonBlockerGpPeaceTargets].
///
/// Returns `const []` for any of the outer guards (in order):
///   1. [isStalledOldWorldExpansion] is `false` for
///      [ConquestSummary.oldWorldProvincesOwned] — outside the stalled
