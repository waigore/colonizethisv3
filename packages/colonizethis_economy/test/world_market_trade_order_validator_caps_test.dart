...
void main() {
  group('TradeOrderValidator.validate — rule 4: bid type cap', () {
    ...
    test('bidTypeCap = 0 does NOT affect offers (offers are not capped by '
        'rule 4)', () {
      final results = TradeOrderValidator.validate(
  ...
  group('TradeOrderValidator.validate — rule 6: bid cargo cap', () {
    ...
    test('per-commodity cap is independent: two distinct bids each at capacity '
  ...
  group('TradeOrderValidator.validate — rule 7: offer stockpile', () {
    ...
    test('offer with no entry in availableStockpileByCommodityId is treated as '
  ...
  group('TradeOrderValidator.validate — rule precedence', () {
    test('mutualExclusion takes precedence over bidTypeCapExceeded (rule 3 '
        'before rule 4)', () {
      final results = TradeOrderValidator.validate(
        context: validatorCtx(
    ...
    test('richesNotTradeable takes precedence over mutualExclusion (rule 2 '
        'before rule 3)', () {
      final results = TradeOrderValidator.validate(
