...
void main() {
  group('computeNonGreatPowerExtraction (SPEC ACs)', () {
    ...
    test('mineral resources on non-GP tiles are unconditionally excluded '
    ...
    test('capital-tile grain bonus is NOT applied to non-GP totals '
    ...
    test('non-GP output is land-only (SPEC AC: no overseas bucket, no GP-side '
