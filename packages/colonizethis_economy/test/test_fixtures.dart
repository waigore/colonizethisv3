...
/// Shared [Game] / [WorldState] factories for economy package tests.
///
...
abstract final class TestFixtures {
  ...
  static Game economyGame({
    String playerId = 'p1',
    Stockpile stockpile = const Stockpile(quantities: {'food': 3, 'silver': 2}),
    Map<String, String> resourceByTileKey = const {'oldWorld|farm|0|0': 'food'},
  }) {
    return minimalGame(
      players: [
        Player(
  ...
  static Game combatGame({
    ...
    return twoPlayerGame(
      player1: Player(id: player1Id, displayName: 'P1', isHuman: true),
      player2: Player(id: player2Id, displayName: 'P2', isHuman: false),
      worldState: worldStateAtOrdersPhase(
        oldWorld: RegionData(
          provinces: [
