// Shared helpers for the First Right of Refusal credit (#2992 D4) unit
// suites. Refs #3427 step 15 — `idx`, `attr`, and `deal` were previously
// duplicated verbatim between `first_right_credits_test.dart` and
// `first_right_credits_aggregation_test.dart`; both now import them here.
