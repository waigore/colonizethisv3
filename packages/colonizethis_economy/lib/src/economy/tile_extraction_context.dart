/// Tile-key → map → resource → province **context resolution** shared by
/// every extraction path (Refs #3517 Cluster 1; phase-7 split Refs #4049).
///
/// The yield-contribution orchestration (production prelude, effective
/// yield) lives in the sibling `tile_extraction_pipeline.dart`, which
/// re-exports this library so callers keep one stable import surface.
library;
