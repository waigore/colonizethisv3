...
void main() {
  ...
  group('Builder unified build_improvement + upgrade_town scoring', () {
    test(
      'AC18: high-value town upgrade beats degenerate build_improvement',
      () {
    ...
    test(
      'AC19: genuine resource improvement still outranks bare town upgrade',
      () {
    ...
    test(
      'AC21: equal scores break by province id (p1 before p2), not order',
      () {
