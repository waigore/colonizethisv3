...
Map<String, TileMapResult> tileMapWithIronTerrain(TerrainType ironTerrain) => {
      ...
      test('true when the co-located iron tile is on prospectable terrain '
        ...
        expect(
          ownsIdleExplorerColocatedWithMineralEligibleUnprospectedOldWorldFeedstockTile(
            ...
            supplierFeedstockId,
            {'iron'},
            tileMapWithIronTerrain(TerrainType.hills),
          ),
          isTrue,
        );
      });
      ...
      test('false when the co-located iron tile is on non-prospectable terrain '
        ...
        expect(
          ownsIdleExplorerColocatedWithMineralEligibleUnprospectedOldWorldFeedstockTile(
            ...
            supplierFeedstockId,
            {'iron'},
            tileMapWithIronTerrain(TerrainType.plains),
          ),
          isFalse,
        );
      });
