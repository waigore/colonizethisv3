...
class NavalCombatResolutionScenario {
...
/// Runs [scenario] (setup + assertions live in [NavalCombatResolutionScenario.run]).
void runNavalCombatResolutionScenario(NavalCombatResolutionScenario scenario) {
  scenario.run();
}
