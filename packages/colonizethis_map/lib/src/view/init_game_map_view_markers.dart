/// Map marker builders for [init_game_map_view_builder.dart]:
...
///
/// Extracted from the former `init_game_map_view_builder_markers_part.dart`
...
class InitGameMapViewMarkers {
  ...
  static final _log = packageLogger();

  static String _homeFleetIdForMapMarker(String playerId) => 'fleet_$playerId';

  static bool _fleetAtHumanCapital(Game game, String playerId, Fleet fleet) {
  ...
  static bool _includeFleetForTileMarker(
    Game game,
    Fleet f,
    String regionId,
    Set<String> humanIds,
  ...
  static String? _inPortFleetMarkerTileKey({
    required Game game,
  ...
  static (int?, int?) _xyFromMapTileKey(String tileKey) {
  ...
  static String? _fleetMarkerTileKeyForLocationScope({
  ...
  static void _addFleetToLocationBuckets({
    required Fleet f,
    required String regionId,
    required Map<String, Province> provinceMap,
