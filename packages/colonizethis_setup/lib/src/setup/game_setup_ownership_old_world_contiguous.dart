...
import 'game_setup_ownership_old_world.dart';
import 'game_setup_ownership_old_world_seeds.dart';
...
Map<String, String> assignOldWorldOwnershipContiguous({
  ...
  final gpSeeds = selectGpSeedsForLandmass(
  ...
  for (var li = 0; li < lmSorted.length; li++) {
    ...
    final part = assignOldWorldSingleLandmass(
      lmId: lmId,
      provs: provs,
      gpHere: gpHere,
      minorHere: minorHere,
  ...
  for (final gpId in gpIds) {
    ...
    assertGpProvincesOnAssignedLandmass(
      gpId: gpId,
