// Scenario table for GP OW terrain redistribution (Refs #4273 slice D).
...
List<RunnableScenario> gpOldWorldTerrainRedistributionScenarios() => [
  rs(
  ...
  rs(
    'same setupSeedBase yields identical OW terrain grid for two runs',
    () {
      const pa = 'pa';
      const pb = 'pb';
      final grid = [
  ...
  rs(
    'moves skewed plains toward capacity-weighted split for two GPs',
    () {
      const pa = 'pa';
      const pb = 'pb';
      final grid = [
