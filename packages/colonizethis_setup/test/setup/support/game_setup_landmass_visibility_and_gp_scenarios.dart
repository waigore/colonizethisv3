...
import 'game_setup_landmass_visibility_and_gp_more_scenarios.dart';

List<RunnableScenario> gameSetupLandmassVisibilityAndGpScenarios() => [
  rs('each GP stays on a single landmass (no cross-continent assignment)', () {
  ...
  ...gameSetupLandmassVisibilityAndGpScenariosMore(),
];
