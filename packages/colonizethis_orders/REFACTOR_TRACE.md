...
## Wave 3 — Slice 103: optional-param dispatch-inline compaction (vwt/waa/wcc)

| scenario_id | test description | source file(s) | target file | refs |
|-------------|------------------|----------------|-------------|------|
| dispatch-inline-vwt-opt | inline 3 default-arg `vwtExpectVisProspect*` wrappers into valid-work-tiles dispatcher | `valid_work_tiles_expectation_shorthand_part1.dart` | `valid_work_tiles_expectations.dart` | #3949 |
| dispatch-inline-waa-opt | inline 4 default-arg `waaExpect*` wrappers into work-order application dispatcher | `work_order_application_expectation_shorthand_part1.dart` | `work_order_application_expectations.dart` | #3949 |
| dispatch-inline-wcc-opt | inline 2 default-arg `wccExpect*` wrappers into work-completion dispatcher | `work_completion_expectation_shorthand_part1.dart` | `work_completion_expectations.dart` | #3949 |
...
## Wave 3 — Slice 108: vwt/wcc single-site dispatcher-inline compaction

| scenario_id | test description | source file(s) | target file | refs |
|-------------|------------------|----------------|-------------|------|
| dispatch-inline-vwt-single | inline eleven single-site `vwtExpect*` wrappers into valid-work-tiles dispatcher | `valid_work_tiles_expectation_shorthand_part1.dart` | `valid_work_tiles_expectations.dart` | #3949 |
| dispatch-inline-wcc-idle | inline `wccExpectUnitIdleCleared` into work-completion dispatcher | `work_completion_expectation_shorthand_part1.dart` | `work_completion_expectations.dart` | #3949 |
...
## Wave 3 — Slice 120: purchase-land fixture DRY + vwt single-tile consolidation
...
## Wave 3 — Slice 124: eliminate remaining `_late` expectation parts

| scenario_id | test description | source file(s) | target file | refs |
|-------------|------------------|----------------|-------------|------|
| vwt-partial-reveal-dispatch | extract `vwtPartialRevealSuggestions` / `vwtExpectPartialRevealSuggestions`; inline six suggest explore/prospect/purchase late cases | `valid_work_tiles_expectations_late.dart` | `valid_work_tiles_expectation_shorthand_part1.dart` + `valid_work_tiles_expectations.dart` | #3949 |
...
## Wave 3 — Slice 128: inline single-use waa/osc/wcc/vwt/vw dispatch helpers

| scenario_id | test description | source file(s) | target file | refs |
|-------------|------------------|----------------|-------------|------|
| waa-dispatch-inline | inline six single-site work-application game/expectation wrappers into dispatcher switch | `work_order_application_expectation_shorthand_part1.dart` | `work_order_application_expectations.dart` | #3949 |
| osc-dispatch-inline | inline counter-spy / purchase-land suggest game builders into dispatcher switch | `order_suggestion_core_expectation_shorthand_part1.dart` | `order_suggestion_core_expectations.dart` | #3949 |
| wcc-dispatch-inline | inline upgrade-town / explore dispatch setup into dispatcher switch | `work_completion_expectation_shorthand_part1.dart` | `work_completion_expectations.dart` | #3949 |
| vwt-dispatch-inline | inline prospect-vis contains check into dispatcher switch | `valid_work_tiles_expectation_shorthand_part1.dart` | `valid_work_tiles_expectations.dart` | #3949 |
| vw-dispatch-inline | fold minor-province road order literal into reject helper | `order_engine_validate_work_expectation_shorthand_part1.dart` | same | #3949 |
