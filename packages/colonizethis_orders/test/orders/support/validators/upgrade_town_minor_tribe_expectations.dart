// Compact upgrade_town Minor/Tribe assertions (Refs #3949 wave 3).
...
/// Pins for [upgradeTownMinorTribeScenarios] rows.
enum UpgradeTownMinorTribeTarget {
  prefilterIncludesMinorTownWhenEmbassyAndPeace,
  precheckRejectsUpgradeTownWhenAtWarWithTribe,
}

void runUpgradeTownMinorTribeExpectation(UpgradeTownMinorTribeTarget target) {
  switch (target) {
    case UpgradeTownMinorTribeTarget.prefilterIncludesMinorTownWhenEmbassyAndPeace:
    ...
    case UpgradeTownMinorTribeTarget.precheckRejectsUpgradeTownWhenAtWarWithTribe:
