// Scenario run tear-offs for ArmyMoveValidator armiesById (Refs #2394, #3949 wave 3).
...
void amvabiRunAcceptedIdenticalWithAndWithout() {
...
void amvabiRunMissingArmyIdRejected() {
  final topology = amvArmiesByIdTwoProvinceTopology();
  final game = amvArmiesByIdSampleGame();
  final view = buildPlayerView(game, topology, 'p1');
...
void amvabiRunIncrementalMatchesDirectValidate() {
  final topology = amvArmiesByIdTwoProvinceTopology();
  final game = amvArmiesByIdSampleGame();
  final view = buildPlayerView(game, topology, 'p1');
  final armiesById = amvArmiesByIdFromGame(game);
...
void amvabiRunFactionMembershipDeclareWarGuard() {
  final topology = amvArmiesByIdTwoProvinceTopology();
