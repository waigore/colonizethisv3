// Scenario run tear-offs for work-order target prechecks (Refs #3949 wave 3).
...
void wotpRunRegistersExpectedTargets() {
...
void wotpRunUnregisteredTargetReturnsNull() {
...
void wotpRunUpgradeTownRejectsNoNationalBureaucracy() {
  final game = workOrderPrecheckBaseGame(
    player: Player(
      id: 'p1',
      displayName: 'P1',
...
void wotpRunSkippingDefaultForeignCheckSet() {
  expect(
...
void wotpRunBuildImprovementRejectsUnprospectedMineral() {
  final game = workOrderPrecheckBaseGame(
...
void wotpRunDefaultForeignProvinceRejectsBuilder() {
...
void wotpRunDevExclusiveTileConflict() {
  final game = workOrderPrecheckBaseGame(
    tileKeysByProvince: {
      workOrderPrecheckProvinceId: [workOrderPrecheckTileKey],
    },
