// Explorer consulate precheck assertions (Refs #3949 wave 3).
...
enum WorkOrderTargetPrechecksExplorerConsulateTarget {
  rejectsExploreWithoutConsulate,
}

void runWorkOrderTargetPrechecksExplorerConsulateExpectation(
  WorkOrderTargetPrechecksExplorerConsulateTarget target,
) {
  switch (target) {
    case WorkOrderTargetPrechecksExplorerConsulateTarget
        .rejectsExploreWithoutConsulate:
