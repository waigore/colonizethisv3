// Compact purchase_land prefilter assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionWorkTilePrefilterPurchaseLandScenarios] rows.
enum OrderSuggestionWorkTilePrefilterPurchaseLandTarget {
  includesMinorExcludesGpOwned,
  includesTribeOwnedProvinces,
  playerOwnedProvinceIdsMatchesDefaultPath,
}

void runOrderSuggestionWorkTilePrefilterPurchaseLandExpectation(
  OrderSuggestionWorkTilePrefilterPurchaseLandTarget target,
) {
  switch (target) {
    case OrderSuggestionWorkTilePrefilterPurchaseLandTarget
        .includesMinorExcludesGpOwned:
