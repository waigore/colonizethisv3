// Draft-work move exclusion assertions (Refs #3949 wave 3).
...
enum OrderSuggestionMoveExcludesUnitWithDraftWorkTarget {
  noMoveWhenDraftWorkExists,
}

void runOrderSuggestionMoveExcludesUnitWithDraftWorkExpectation(
  OrderSuggestionMoveExcludesUnitWithDraftWorkTarget target,
) {
  switch (target) {
    case OrderSuggestionMoveExcludesUnitWithDraftWorkTarget
        .noMoveWhenDraftWorkExists:
