// Scenario run tear-offs for order_suggestion_diplomatic_validator_reuse (Refs #3949 wave 3).
...
void osdvrRunOnePassLevelValidatorAcrossTargets() {
  ...
  expect(suggestions.where((o) => o.targetFactionId == 'gp2'), hasLength(1));
...
void osdvrRunSkipsPassLevelBuildWhenSharedSupplied() {
  final game = dvrTwoGpPeaceGame();
  final view = buildPlayerView(game, dvrEmptyTopology, 'gp1');
...
void osdvrRunRebindsPassValidatorAfterEachTarget() {
  ...
  expect(suggestions.map((o) => o.targetFactionId).toSet(), {'gp2', 'gp3'});
  expect(
    incrementalCandidateValidatorBuildCountForTests,
    1,
