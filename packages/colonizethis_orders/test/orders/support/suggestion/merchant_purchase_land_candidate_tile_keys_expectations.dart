// Compact merchant purchase-land candidate tile keys assertions (Refs #3949 wave 3).
...
/// Pins for [merchantPurchaseLandCandidateTileKeysScenarios] rows.
enum MerchantPurchaseLandCandidateTileKeysTarget {
  listsNwBeforeOw,
  matchesProvinceScanMembership,
  matchesProjectionUnion,
  excludesDevExclusiveReserved,
}

void runMerchantPurchaseLandCandidateTileKeysExpectation(
  MerchantPurchaseLandCandidateTileKeysTarget target,
) {
  switch (target) {
    case MerchantPurchaseLandCandidateTileKeysTarget.listsNwBeforeOw:
    ...
    case MerchantPurchaseLandCandidateTileKeysTarget.matchesProvinceScanMembership:
    ...
    case MerchantPurchaseLandCandidateTileKeysTarget.matchesProjectionUnion:
    ...
    case MerchantPurchaseLandCandidateTileKeysTarget.excludesDevExclusiveReserved:
