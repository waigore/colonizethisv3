// Full-candidate snapshot assertions (Refs #3949 wave 3).
...
enum OrderSuggestionFullCandidateSnapshotTarget {
  stableSnapshot,
}

void runOrderSuggestionFullCandidateSnapshotExpectation(
  OrderSuggestionFullCandidateSnapshotTarget target,
) {
  switch (target) {
    case OrderSuggestionFullCandidateSnapshotTarget.stableSnapshot:
