...
void osplppRunCoLocatedExplorerReceivesProspectInLateSortedProvince() {final game = orderSuggestionProspectLocationProvincePriorityGame(); final topology = orderSuggestionProspectLocationProvincePriorityTopology(game,); final view = buildPlayerView(game,topology,orderSuggestionProspectLocationProvincePriorityPlayerId,); final suggestions = suggestWorkOrders(view,game,topology,const Orders()); final prospects = suggestions.where((o) => o.unitId == orderSuggestionProspectLocationProvincePriorityExplorerUnitId && o.target == kWorkTargetProspect,).toList(); expect(prospects,isNotEmpty); expect(prospects.map((o) => o.targetTileKey),contains(orderSuggestionProspectLocationProvincePriorityIronTileKey),);}

void osplppRunNoProspectWithoutFoggedVisibility() {final game = orderSuggestionProspectLocationProvincePriorityGame(includeFoggedVisibility: false,); final topology = orderSuggestionProspectLocationProvincePriorityTopology(game,); final view = buildPlayerView(game,topology,orderSuggestionProspectLocationProvincePriorityPlayerId,); final suggestions = suggestWorkOrders(view,game,topology,const Orders()); expect(suggestions.where((o) => o.target == kWorkTargetProspect),isEmpty);}
