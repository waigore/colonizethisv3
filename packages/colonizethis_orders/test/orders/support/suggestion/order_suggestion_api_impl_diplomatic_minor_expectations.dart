// Compact diplomatic-minor API impl suggestion assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionApiImplDiplomaticMinorScenarios] rows.
enum OrderSuggestionApiImplDiplomaticMinorTarget {
...
void runOrderSuggestionApiImplDiplomaticMinorExpectation(
  OrderSuggestionApiImplDiplomaticMinorTarget target,
) {
  switch (target) {
    case OrderSuggestionApiImplDiplomaticMinorTarget
        .doesNotSuggestForCompletelyUnknownFactions:
    ...
    case OrderSuggestionApiImplDiplomaticMinorTarget
        .doesNotSuggestAdvancedOvertureWithoutDiplomaticExpertise:
      final list =
          _suggestFor(diplomaticMinorApiImplNoDiplomaticExpertiseGame());
      final overture = list
          .where((o) => o.type == DiplomaticOrderType.establishOverture)
    ...
    case OrderSuggestionApiImplDiplomaticMinorTarget
      ...
      final toMinor1 =
          list.where((o) => o.targetFactionId == 'minor1').toList();
