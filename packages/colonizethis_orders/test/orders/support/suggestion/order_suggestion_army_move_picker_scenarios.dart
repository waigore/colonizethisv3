...
void osampRunCachedPlayerOwnedMatchesDefaultDestinationPickerPath() {final game = armyMovePickerGameTwoNeighborsWithNw(id: 'g_army_picker_dest_ids',); final topology = armyMovePickerTopologyFourProvinces(); final army = armyMovePickerFieldArmy(game); final uncached = armyMovePickerDestinations(game: game,topology: topology,playerId: armyMovePickerGp,army: army,currentOrders: const Orders(),); final owned = <String>{for (final p in allProvinces(game.worldState)) if (p.ownerId == armyMovePickerGp) toFullProvinceId(p.regionId,p.id),}; final cached = armyMovePickerDestinations(game: game,topology: topology,playerId: armyMovePickerGp,army: army,currentOrders: const Orders(),playerOwnedFullProvinceIds: owned,); expect(cached,uncached);}

void osampRunSharedPlayerViewMatchesDefaultArmyMovePickerDestinations() {final game = armyMovePickerGameTwoNeighborsWithNw(id: 'g_army_picker_shared_view',); final topology = armyMovePickerTopologyFourProvinces(); final army = armyMovePickerFieldArmy(game); final baseline = armyMovePickerDestinations(game: game,topology: topology,playerId: armyMovePickerGp,army: army,currentOrders: const Orders(),); final view = buildPlayerView(game,topology,armyMovePickerGp); final unitsById = unitsByIdFromWorld(game.worldState); final withShared = armyMovePickerDestinations(game: game,topology: topology,playerId: armyMovePickerGp,army: army,currentOrders: const Orders(),resolution: orderResolutionContextFromView(view,game,unitsById: unitsById,),); expect(withShared,baseline);}
