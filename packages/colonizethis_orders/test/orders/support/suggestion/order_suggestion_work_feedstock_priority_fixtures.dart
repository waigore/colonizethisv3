...
Game feedstockCoAvailGame({
  ...
  tileKeysByRegionAndProvince: const {
    kRegionOldWorld: {
      'oldWorld|gp1-s0': [feedstockCoAvailTimberTile, feedstockCoAvailIronTile],
...
MapTopology feedstockPriorityTopology(Game game) => ordersProvinceTopology(
