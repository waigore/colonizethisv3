// Compact diplomatic GP API impl suggestion assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionApiImplDiplomaticScenarios] rows.
enum OrderSuggestionApiImplDiplomaticTarget {
  returnsAllianceSingleDiploPerTarget,
  returnsDeclareWarWhenAllied,
...
void runOrderSuggestionApiImplDiplomaticExpectation(
  OrderSuggestionApiImplDiplomaticTarget target,
) {
  switch (target) {
    case OrderSuggestionApiImplDiplomaticTarget.returnsAllianceSingleDiploPerTarget:
    ...
    case OrderSuggestionApiImplDiplomaticTarget.returnsDeclareWarWhenAllied:
      final list = _suggestFor(
        diplomaticApiImplGame(
          diplomacyRelations: const [
            DiplomacyRelation(
    ...
    case OrderSuggestionApiImplDiplomaticTarget
        .returnsBreakAllianceWhenFormalAllianceExists:
      final list = _suggestFor(
        diplomaticApiImplGame(
          diplomacyRelations: const [
    ...
    case OrderSuggestionApiImplDiplomaticTarget.returnsOfferPeaceWhenAtWar:
      final list = _suggestFor(
        diplomaticApiImplGame(
          diplomacyRelations: const [
            DiplomacyRelation(
