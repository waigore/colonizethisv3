// Lock-recovery affordability guard assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionBuildLockRecoveryAffordabilityGuardScenarios] rows.
enum OrderSuggestionBuildLockRecoveryAffordabilityGuardTarget {
...
void runOrderSuggestionBuildLockRecoveryAffordabilityGuardExpectation(
  OrderSuggestionBuildLockRecoveryAffordabilityGuardTarget target,
) {
  switch (target) {
    case OrderSuggestionBuildLockRecoveryAffordabilityGuardTarget
        .positiveControlRichesFundRegiment:
    ...
    case OrderSuggestionBuildLockRecoveryAffordabilityGuardTarget.aiNoBypass:
