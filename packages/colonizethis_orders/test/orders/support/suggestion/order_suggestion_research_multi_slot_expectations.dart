// Compact multi-slot research suggestion assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionResearchMultiSlotScenarios] rows.
enum OrderSuggestionResearchMultiSlotTarget {
  fillsEveryEmptySlotWithDistinctResearchableTech,
  reEmitsInProgressResearch,
  returnsNoSuggestionsWhenZeroResearchSlots,
  doesNotReSuggestTechAlreadyAssignedByPendingOrder,
}

void runOrderSuggestionResearchMultiSlotExpectation(
  OrderSuggestionResearchMultiSlotTarget target,
) {
  switch (target) {
    case OrderSuggestionResearchMultiSlotTarget
        .fillsEveryEmptySlotWithDistinctResearchableTech:
      const player = Player(
    ...
    case OrderSuggestionResearchMultiSlotTarget.reEmitsInProgressResearch:
