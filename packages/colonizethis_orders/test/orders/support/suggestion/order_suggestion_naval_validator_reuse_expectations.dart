// Naval validator-reuse assertions (Refs #2394, #3949 wave 3).
...
/// Pins for [orderSuggestionNavalValidatorReuseScenarios] rows.
enum OrderSuggestionNavalValidatorReuseTarget {
  moveAndMissionReuseOneValidator,
}

const _emptyOrders = Orders();

void runOrderSuggestionNavalValidatorReuseExpectation(
  OrderSuggestionNavalValidatorReuseTarget target,
) {
  switch (target) {
    case OrderSuggestionNavalValidatorReuseTarget.moveAndMissionReuseOneValidator:
