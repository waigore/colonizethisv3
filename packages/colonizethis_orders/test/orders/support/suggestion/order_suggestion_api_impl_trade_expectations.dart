// Compact trade API impl suggestion assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionApiImplTradeScenarios] rows.
enum OrderSuggestionApiImplTradeTarget {
  noEmbassyBidTypeCapZeroOffersFromStockpileNoBids,
  contextOverridePassesThroughToPureSuggester,
  defaultImplReturnsValidatorCleanOutputForWiredContext,
}

const _api = DefaultOrderSuggestionAPI();

void runOrderSuggestionApiImplTradeExpectation(
  OrderSuggestionApiImplTradeTarget target,
) {
  switch (target) {
    case OrderSuggestionApiImplTradeTarget
        .noEmbassyBidTypeCapZeroOffersFromStockpileNoBids:
