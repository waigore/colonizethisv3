...
Province _armyMoveCap() => Province(
  id: armyMoveCap,
  regionId: 'oldWorld',
  ownerId: armyMoveGp,
...
Province _armyMoveOwned(String id, {String regionId = 'oldWorld'}) =>
    Province(id: id, regionId: regionId, ownerId: armyMoveGp);
...
Game armyMoveGame0({String? extraNeighborProvinceId}) {
  final provinces = <Province>[
    ...
    if (extraNeighborProvinceId != null)
      _armyMoveOwned(extraNeighborProvinceId),
  ];
  return ordersOwRegionGame(
    ...
    newWorld: RegionData(
      provinces: [_armyMoveOwned(armyMoveNw, regionId: 'newWorld')],
    ),
    armies: [
      Army(
...
MapTopology armyMoveTopology0({bool includeP2 = false}) {
  ...
  final nodes = <TopologyNode>[
    ...
    if (includeP2)
      const TopologyNode(id: 'oldWorld|p2', regionId: 'oldWorld', type: TopologyNodeType.province),
  ];
  // dart format on
  return MapTopology(
    nodes: nodes,
    edges: [
      if (includeP2) const TopologyEdge(id1: 'oldWorld|p1', id2: 'oldWorld|p2'),
    ],
  );
}
