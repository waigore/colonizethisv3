// Compact work-tile-keys shared-validator assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionWorkTileKeysSharedValidatorScenarios] rows.
enum OrderSuggestionWorkTileKeysSharedValidatorTarget {
...
void runOrderSuggestionWorkTileKeysSharedValidatorExpectation(
  OrderSuggestionWorkTileKeysSharedValidatorTarget target,
) {
  switch (target) {
    case OrderSuggestionWorkTileKeysSharedValidatorTarget
        .sharedCandidateValidatorMatchesDefaultPath:
