// Compact order suggestion unit availability assertions (Refs #3949 wave 3).
...
/// Pins for [orderSuggestionUnitAvailabilityScenarios] rows.
enum OrderSuggestionUnitAvailabilityTarget {
  pendingDraftShortCircuits,
  pendingDraftZeroProbesScale,
  multiTargetMatchesSharedValidator,
}

void runOrderSuggestionUnitAvailabilityExpectation(
  OrderSuggestionUnitAvailabilityTarget target,
) {
  switch (target) {
    case OrderSuggestionUnitAvailabilityTarget.pendingDraftShortCircuits:
    ...
    case OrderSuggestionUnitAvailabilityTarget.pendingDraftZeroProbesScale:
      setOrderSuggestionWorkOrderAcceptanceProbeTrackingForTests(true);
      addTearDown(
        () => setOrderSuggestionWorkOrderAcceptanceProbeTrackingForTests(false),
      );
    ...
    case OrderSuggestionUnitAvailabilityTarget.multiTargetMatchesSharedValidator:
