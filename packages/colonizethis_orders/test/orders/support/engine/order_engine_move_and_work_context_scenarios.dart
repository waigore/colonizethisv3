...
List<OrderEngineMoveAndWorkContextScenario> orderEngineMoveAndWorkContextScenarios() =>
    const [
      ...
      OrderEngineMoveAndWorkContextScenario(
        ...
        target:
            OrderEngineMoveAndWorkContextTarget.workExploreRejectedWhenProvinceUnknown,
      ),
      OrderEngineMoveAndWorkContextScenario(
      ...
      OrderEngineMoveAndWorkContextScenario(
        ...
        target:
            OrderEngineMoveAndWorkContextTarget.workProspectAcceptedWhenMineralEligible,
      ),
      OrderEngineMoveAndWorkContextScenario(
        label:
            'work order prospect rejected in Tribe province without a consulate (Refs #3753 R4)',
        target:
            OrderEngineMoveAndWorkContextTarget.workProspectRejectedWithoutConsulate,
        refs: '#3753',
      ),
      OrderEngineMoveAndWorkContextScenario(
