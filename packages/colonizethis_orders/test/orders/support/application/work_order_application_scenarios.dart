...
void waaRunBuildFortWithSufficientMaterialsDeductsMaterials() {
  ...
  waaExpectStockpileDeducted(
    game,
    waaApply(game, workAppSingleWorkOrder(target: kWorkTargetBuildFort)),
    workOrderCostBuildFort(0),
  );
}
...
void waaRunCounterSpyWorkOrderSetsCurrentWorkForSpyUnitOnOwnedCapitalProvince() {
  ...
  expect(waaSingleUnit(next).currentWork?.workTarget, kWorkTargetCounterSpy);
}
