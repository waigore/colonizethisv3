...
import '../support/validators/move_validator_test_support.dart';
...
void main() {
  group('MoveValidator', () {
    ...
    test('explorer can move cross-region into tribe-owned province', () {
      const nw = 'newWorld';
      ...
      final result = validator.validate(
        ...
        game,
        'p1',
        moveValidatorTestContext(game, combinedTopology, 'p1'),
        const [],
        combinedTopology,
        previousRejected: false,
      );
    ...
    test('builder cross-region into tribe-owned province is still invalid', () {
      const nw = 'newWorld';
      final combinedTopology = MapTopology(
        nodes: const [
          TopologyNode(id: 'P1', regionId: ow, type: TopologyNodeType.province),
