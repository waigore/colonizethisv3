...
void main() {
  runLabeledScenarioGroup('developmentPanelAssignPreview', [
    rs('selectDevelopmentImproveAssignCandidate attaches level 1 cost 4+4', () {
        ...
        final game = s.game().copyWith(
          ...
          worldState: s.world().copyWith(
            tileState: TileMapState(
              improvementByTile: {s.tileA: 1, s.tileB: 0},
            ),
          ),
        );
        final candidate = selectDevelopmentImproveAssignCandidate(
