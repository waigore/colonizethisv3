...
void main() {
  ...
  group('e2eWaitUntilFound — post-pump final check', () {
    ...
    testWidgets('still fails with TestFailure when the finder remains empty', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('invokes the diagnoseAfter post-pump final check when the '
      ...
      // the target.
      final spy = FlipFinder(find.byKey(targetKey), succeedOnCall: 3);
  ...
  registerE2eBusyWaitFinalCheckGuardGroup();
}
