...
import 'support/e2e_fleet_reach_loop_exit_test_total_meta_label_tail_group.dart';
...
void main() {
  ...
  group(
    ...
    () {
      test('reachedSnapshotPrecheck -> result=reached_snapshot_precheck', () {
        expect(
      ...
      test('reachedSnapshotAfterRegionTab -> result=reached_snapshot_precheck '
          '(LEGACY label pin)', () {
        expect(
          e2eFleetReachLoopExitTestTotalMetaLabel(
  ...
  registerE2eFleetReachLoopExitTestTotalMetaLabelTailGroups();
}
