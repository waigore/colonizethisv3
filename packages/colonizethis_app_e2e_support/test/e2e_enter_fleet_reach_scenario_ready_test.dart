...
import 'support/e2e_enter_fleet_reach_scenario_ready_guard_group.dart';
...
void main() {
  ...
  group('e2eEnterFleetReachScenarioReady — default constants', () {
    test(
      'kE2eDefaultFleetReachPreambleMaxUiResponseWait preserves the '
  ...
  registerE2eEnterFleetReachScenarioReadyGuardGroup();
}
