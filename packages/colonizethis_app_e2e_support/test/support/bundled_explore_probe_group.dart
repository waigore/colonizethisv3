...
void registerBundledExploreProbeGroup() {
  group('e2eBundledExploreRejectionDiagnostics — per-province probe', () {
    test('explorer + multiple provinces → sorted per-province lines', () {
      ...
      final explorer = makeExplorerUnit(
        id: 'ex1',
    ...
    test('province ownerKind classifications cover none / tribe / minor / gp / self', () {
      ...
      // surface immediately.
      final explorer = makeExplorerUnit(id: 'ex1', provinceId: 'oldWorld|none');
      final game = Game(
        id: 'g-owner-kinds',
        worldState: world(
          oldWorld: RegionData(
            provinces: const [
              ...
              Province(id: 'oldWorld|self', regionId: 'oldWorld', ownerId: human),
      ...
      expect(
        diag,
        contains(
          'diag: province=oldWorld|self owner=$human ownerKind=self ',
        ),
