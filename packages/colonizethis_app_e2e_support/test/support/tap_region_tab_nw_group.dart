...
void registerTapRegionTabNwGroup() {
  group('e2eTapNewWorldRegionTabIfPresent', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await pumpScaffold(tester, const NewWorldRegionTabHost());
        final hostState = tester.state<NewWorldRegionTabHostState>(
          find.byType(NewWorldRegionTabHost),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await pumpScaffold(
          tester,
          const NewWorldRegionTabHost(initialSelected: true),
        );
        final hostState = tester.state<NewWorldRegionTabHostState>(
          find.byType(NewWorldRegionTabHost),
        );
