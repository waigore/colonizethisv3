  ...
  group('e2eTapOldWorldRegionTab', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await pumpScaffold(tester, const SizedBox());
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await pumpScaffold(
          tester,
          OldWorldRegionTabHost(label: l10n.region_oldWorld),
        );
        final hostState = tester.state<OldWorldRegionTabHostState>(
          find.byType(OldWorldRegionTabHost),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final hostStates = tester
            .stateList<OldWorldRegionTabHostState>(
              find.byType(OldWorldRegionTabHost),
            )
            .toList();
